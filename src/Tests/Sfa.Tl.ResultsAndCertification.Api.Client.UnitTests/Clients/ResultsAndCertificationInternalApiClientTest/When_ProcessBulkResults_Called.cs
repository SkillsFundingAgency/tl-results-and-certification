...
{
    public class When_ProcessBulkResults_Called : BaseTest<ResultsAndCertificationInternalApiClient>
    {
        protected ITokenServiceClient _tokenServiceClient;
        protected ResultsAndCertificationConfiguration _configuration;
        protected BulkResultResponse _result;

        protected ResultsAndCertificationInternalApiClient _apiClient;
        protected BulkResultResponse _mockHttpResult;
        ...
        {
            HttpClient = new HttpClient(new MockHttpMessageHandler<BulkResultResponse>(_mockHttpResult, ApiConstants.ProcessBulkResultsUri, HttpStatusCode.OK, JsonConvert.SerializeObject(_model)));
