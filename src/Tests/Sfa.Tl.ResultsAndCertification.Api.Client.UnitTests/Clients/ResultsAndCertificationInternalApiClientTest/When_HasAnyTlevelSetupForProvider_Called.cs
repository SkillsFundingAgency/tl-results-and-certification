...
{
    public class When_HasAnyTlevelSetupForProvider_Called : BaseTest<ResultsAndCertificationInternalApiClient>
    {
        // Dependencies
        ...
        {
            _result = await _apiClient.HasAnyTlevelSetupForProviderAsync(_ukprn, _tlProviderId);
        }
