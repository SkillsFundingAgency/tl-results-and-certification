...
namespace Sfa.Tl.ResultsAndCertification.Api.Client.UnitTests.Clients.ResultsAndCertificationInternalApiClientTest
{
    public class When_ProcessAdminAddSpecialismResult_Called : BaseTest<ResultsAndCertificationInternalApiClient>
    {
        ...
        {
            HttpClient = new HttpClient(new MockHttpMessageHandler<bool>(_mockHttpResult, ApiConstants.ProcessAdminAddSpecialismResultUri, HttpStatusCode.OK, JsonConvert.SerializeObject(_model)));
