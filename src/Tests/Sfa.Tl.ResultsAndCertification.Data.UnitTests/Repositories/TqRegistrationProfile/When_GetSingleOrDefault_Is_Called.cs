...
{
    public class When_GetSingleOrDefault_Is_Called : BaseTest<Domain.Models.TqRegistrationProfile>
    {
        ...
        public void Then_Fields_Are_As_Expected()
        {
            ...
            _result.IsEnglishAchieved.Should().Be(_data.IsEnglishAndMathsAchieved);
            _result.IsMathsAchieved.Should().Be(_data.IsEnglishAndMathsAchieved);
