...
{
    public class When_GetMany_Is_Called : BaseTest<Domain.Models.IpTempFlexTlevelCombination>
    {
        private IEnumerable<Domain.Models.IpTempFlexTlevelCombination> _result;
        private IEnumerable<Domain.Models.IpTempFlexTlevelCombination> _data;
