...
using Sfa.Tl.ResultsAndCertification.IntegrationTests.CommonServices.CsvHelperServiceTests.ValidationErrorsBuilder;
...
{
    public class When_Registrations_Upload_File_Has_Records_But_Empty_Data : RegistrationsCsvHelperServiceBaseTest
    {
        ...
        [Fact]
        public void Then_Expected_Required_Validation_Errors_Are_Returned()
        {
