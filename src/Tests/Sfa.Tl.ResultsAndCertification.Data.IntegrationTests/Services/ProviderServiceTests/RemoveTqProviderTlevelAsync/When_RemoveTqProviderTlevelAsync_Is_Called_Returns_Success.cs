...
{
    public class When_RemoveTqProviderTlevelAsync_Is_Called_Returns_Success : ProviderServiceBaseTest
    {
        ...
        {
            _result = ProviderService.RemoveTqProviderTlevelAsync(TlAwardingOrganisation.UkPrn, TqProvider.Id).Result;
        }
