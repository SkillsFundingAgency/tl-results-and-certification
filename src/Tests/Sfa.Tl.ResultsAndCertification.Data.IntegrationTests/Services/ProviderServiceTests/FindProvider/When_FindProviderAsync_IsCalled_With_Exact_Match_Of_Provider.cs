...
{
    public class When_FindProviderAsync_IsCalled_With_Exact_Match_Of_Provider : ProviderServiceBaseTest
    {
        private IEnumerable<ProviderMetadata> _result;
        
        // parameters
        private string _providerName = "Bishop Burton College";
        ...
        public void Then_Expected_Results_Is_Returned()
        {
            ...
            _result.First().DisplayName.Should().Be(_providerName);
        }
    }
}