...
{
    public class When_File_HasInvalidHeader : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            {
                IsDirty = true,
                ErrorMessage = ValidationMessages.FileHeaderNotFound,
                ErrorCode = CsvFileErrorCode.HeaderInvalid
            };
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            CsvService.Received(1).WriteFileAsync(Arg.Is<List<BulkProcessValidationError>>(x => x.First().ErrorMessage.Equals(csvResponse.ErrorMessage)));
