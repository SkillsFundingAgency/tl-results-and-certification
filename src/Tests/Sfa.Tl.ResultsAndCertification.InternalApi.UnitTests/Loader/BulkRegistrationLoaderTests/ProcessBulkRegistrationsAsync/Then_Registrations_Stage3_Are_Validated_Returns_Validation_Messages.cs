    ...
    public class Then_Registrations_Stage3_Are_Validated_Returns_Validation_Messages : When_ProcessBulkRegistrationsAsync_Is_Called
    {
        public override void Given()
        {
            var expectedStage2Response = new List<RegistrationCsvRecordResponse>
                {
                    new RegistrationCsvRecordResponse { RowNum = 1, Uln = 1111111111, FirstName = "", LastName = "Last3", DateOfBirth = "01/01/1990".ToDateTime(),  ProviderUkprn = 33333333, StartDate = "10/06/2020".ToDateTime(), CoreCode ="12333333", SpecialismCodes = new List<string> {"234567819"}, ValidationErrors = new List<RegistrationValidationError>
                    {
                        new RegistrationValidationError { RowNum = "1", Uln = "1111111111", ErrorMessage = "First name required" }
                    } },
                    new RegistrationCsvRecordResponse { RowNum = 2, Uln = 1111111112, FirstName = "First2", LastName = "", DateOfBirth = "01/01/1990".ToDateTime(),  ProviderUkprn = 33333333, StartDate = "10/06/2020".ToDateTime(), CoreCode ="12333333", SpecialismCodes = new List<string> {"234567819"}, ValidationErrors = new List<RegistrationValidationError>
                    {
                        new RegistrationValidationError { RowNum = "2", Uln = "1111111112", ErrorMessage = "Last name required" }
                    } },
                    new RegistrationCsvRecordResponse { RowNum = 3, Uln = 1111111113, FirstName = "First3", LastName = "Last3", DateOfBirth = "01/01/1990".ToDateTime(),  ProviderUkprn = 00000000, StartDate = "10/06/2020".ToDateTime(), CoreCode ="12333333", SpecialismCodes = new List<string> {"234567819"} },
                    new RegistrationCsvRecordResponse { RowNum = 4, Uln = 1111111114, FirstName = "First4", LastName = "Last4", DateOfBirth = "01/01/1990".ToDateTime(),  ProviderUkprn = 33333333, StartDate = "10/06/2020".ToDateTime(), CoreCode ="00000000", SpecialismCodes = new List<string> {"234567819"} },
                    new RegistrationCsvRecordResponse { RowNum = 5, Uln = 1111111115, FirstName = "First5", LastName = "Last5", DateOfBirth = "01/01/1990".ToDateTime(),  ProviderUkprn = 33333333, StartDate = "10/06/2020".ToDateTime(), CoreCode ="12333333", SpecialismCodes = new List<string> {"000000000"} },
                };
