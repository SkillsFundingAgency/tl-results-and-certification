...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.ResultControllerTests.ResultsDownloadDataLink
{
    public class When_Called_With_Valid_Data_For_Specialism : TestSetup
    {
        public override void Given()
        {
            ...
            ResultLoader.GetResultsDataFileAsync(AoUkprn, Id.ToGuid(), ComponentType).Returns(new MemoryStream(Encoding.ASCII.GetBytes("Test File for specialism Result entries")));
        }
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            viewResult.FileDownloadName.Should().Be(ResultContent.ResultsDownloadData.Specialism_Results_Download_FileName);
