...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.ResultControllerTests.AddResultConfirmation
{
    public abstract class TestSetup : BaseTest<ResultController>
    {
        ...
        protected ResultConfirmationViewModel ViewModel;
        ...
        {
            Result = await Controller.AddResultConfirmationAsync();
        }
    }
}
