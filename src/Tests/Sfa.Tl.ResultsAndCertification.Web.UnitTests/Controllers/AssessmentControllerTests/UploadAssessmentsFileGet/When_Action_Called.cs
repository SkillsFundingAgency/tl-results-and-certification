...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AssessmentControllerTests.UploadAssessmentsFileGet
{
    public class When_Action_Called : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            var model = (Result as ViewResult).Model as UploadAssessmentsRequestViewModel;
            ...
            model.Breadcrumb.BreadcrumbItems[2].DisplayName.Should().Be(BreadcrumbContent.Upload_Assessments_File);
        }
    }
}
