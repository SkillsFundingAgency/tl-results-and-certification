...
{
    public class When_Called_And_Cache_Contains_Valid_Data_Non_Existing_Provider_Search : SearchRegistrationControllerTestBase
    {
        ...
        public override void Given()
        {
            ...
            ProviderLoader.GetProviderLookupDataAsync(_filtersViewModel.Search, isExactMatch: true).Returns(null as IEnumerable<ProviderLookupData>);
        }
        ...
        public void Then_Expected_Methods_AreCalled()
        {
            ...
            CacheService.Received(1).SetAsync(CacheKey, Arg.Is<SearchRegistrationViewModel>(
                ...
                && p.Criteria.Filters.SelectedProviderId == 0));
        }
