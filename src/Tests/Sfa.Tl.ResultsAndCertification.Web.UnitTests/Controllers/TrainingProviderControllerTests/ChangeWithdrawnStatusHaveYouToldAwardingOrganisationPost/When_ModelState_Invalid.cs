...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.TrainingProviderControllerTests.ChangeWithdrawnStatusHaveYouToldAwardingOrganisationPost
{
    public class When_ModelState_Invalid : TestSetup
    {
        public override void Given()
        {
            ...
            Controller.ModelState.AddModelError(nameof(ChangeWithdrawnStatusHaveYouToldAwardingOrganisationViewModel.HaveYouToldAwardingOrganisation), Content.TrainingProvider.WithdrawnConfirmation.Validation_Message);
        }
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            viewResult.Model.Should().BeOfType(typeof(ChangeWithdrawnStatusHaveYouToldAwardingOrganisationViewModel));
            ...
            Controller.ViewData.ModelState.ContainsKey(nameof(ChangeWithdrawnStatusHaveYouToldAwardingOrganisationViewModel.HaveYouToldAwardingOrganisation)).Should().BeTrue();

            var modelState = Controller.ViewData.ModelState[nameof(ChangeWithdrawnStatusHaveYouToldAwardingOrganisationViewModel.HaveYouToldAwardingOrganisation)];
            modelState.Errors[0].ErrorMessage.Should().Be(Content.TrainingProvider.WithdrawnConfirmation.Validation_Message);
