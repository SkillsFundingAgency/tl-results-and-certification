...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.TrainingProviderControllerTests.ChangeWithdrawnStatusHaveYouToldAwardingOrganisationPost
{
    public abstract class TestSetup : TrainingProviderControllerTestBase
    {
        ...
        public ChangeWithdrawnStatusHaveYouToldAwardingOrganisationViewModel ViewModel { get; set; }
        public IActionResult Result { get; private set; }

        public async override Task When()
        {
            Result = await Controller.ChangeWithdrawnStatusHaveYouToldAwardingOrganisationAsync(ViewModel);
        }
    }
}
