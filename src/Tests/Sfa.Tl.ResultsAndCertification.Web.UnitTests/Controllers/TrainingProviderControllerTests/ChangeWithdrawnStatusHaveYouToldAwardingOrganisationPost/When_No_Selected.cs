    ...
    public class When_No_Selected: TestSetup
    {
        ...
        public void Then_Expected_Methods_Called()
        {
            ...
            CacheService.Received(1).SetAsync(InformationCacheKey, Arg.Is<InformationBannerModel>(x =>
                ...
                x.Message.Equals(string.Format(LearnerDetailsContent.Withdrawn_Message_Told_AO_No_Template, ViewModel.LearnerName, ViewModel.AwardingOrganisationName))),
        ...
        public void Then_Redirected_To_LearnerRecordDetails()
        {
            ...
            result.RouteName.Should().Be(RouteConstants.WithdrawLearnerAOMessage);
