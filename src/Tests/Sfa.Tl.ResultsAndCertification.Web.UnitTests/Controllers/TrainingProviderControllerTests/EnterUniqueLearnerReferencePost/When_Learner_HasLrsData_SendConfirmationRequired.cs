...
{
    public class When_Learner_HasLrsData_SendConfirmationRequired : TestSetup
    {       
        ...
        {
            _learnerRecord = new FindLearnerRecord { Uln = 1234567890, Name = "Test Name", IsLearnerRegistered = true, HasLrsEnglishAndMaths = true, IsSendConfirmationRequired = true };
        ...
        [Fact]
        public void Then_Redirected_To_AddEnglishAndMathsLrsQuestion()
        {
            var actualRouteName = (Result as RedirectToRouteResult).RouteName;
            actualRouteName.Should().Be(RouteConstants.AddEnglishAndMathsLrsQuestion);
        }
    }
}
