...
{
    public class When_Called_With_Valid_Data_RegistrationPathwayStatus_Active_PendingWithdrawal_True : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            model.SummaryTLevelStatus.Value.Should().Be(LearnerRecordDetailsContent.TLevel_Status_Pending_Withdrawal_Text);
            model.SummaryTLevelStatus.HasTag.Should().BeTrue();
            model.SummaryTLevelStatus.TagCssClass.Should().Be("govuk-tag--blue");
