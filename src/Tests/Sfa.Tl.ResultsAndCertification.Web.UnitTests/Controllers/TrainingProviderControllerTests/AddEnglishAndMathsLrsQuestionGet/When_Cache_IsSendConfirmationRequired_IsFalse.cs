...
{
    public class When_Cache_IsSendConfirmationRequired_IsFalse : TestSetup
    {
        ...
        {
            _learnerRecord = new FindLearnerRecord { IsLearnerRegistered = true, HasLrsEnglishAndMaths = true, IsSendConfirmationRequired = false };
