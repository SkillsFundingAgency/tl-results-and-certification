...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.TrainingProviderControllerTests.Index
{
    public class When_Action_Called : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            var model = (Result as ViewResult).Model as DashboardViewModel;
            ...
            model.Breadcrumb.BreadcrumbItems[1].DisplayName.Should().Be(BreadcrumbContent.Manage_Learner_TLevel_Records);
        }
    }
}
