...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.TrainingProviderControllerTests.SearchLearnerDetailsGet
{
    public class When_Called_With_Valid_Data : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            searchFilters.IndustryPlacementStatus.Should().NotBeNull();
            searchFilters.IndustryPlacementStatus.Should().HaveCount(_searchFilters.IndustryPlacementStatus.Count);
            searchFilters.IndustryPlacementStatus.Should().BeEquivalentTo(_searchFilters.IndustryPlacementStatus);
