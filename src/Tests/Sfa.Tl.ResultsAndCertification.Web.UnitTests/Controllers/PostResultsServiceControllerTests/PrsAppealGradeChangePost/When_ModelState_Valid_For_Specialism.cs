...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.PostResultsServiceControllerTests.PrsAppealGradeChangePost
{
    public class When_ModelState_Valid_For_Specialism : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            _grades = new List<LookupViewModel> { new LookupViewModel { Id = 1, Code = "Merit", Value = "Merit" }, new LookupViewModel { Id = 2, Code = "Pass", Value = "Pass" } };
            ...
            ViewModel = new PrsAppealGradeChangeViewModel { ProfileId = ProfileId, AssessmentId = AssessmentId, ComponentType = ComponentType, SelectedGradeCode = "Merit", Grades = _grades };
        }
        ...
        public void Then_Expected_Methods_AreCalled()
        {
            ...
            CacheService.Received(1).SetAsync(CacheKey,
                ...
                (x => x.ProfileId == _prsAppealCheckAndSubmitViewModel.ProfileId &&
                      ...
                      x.SpecialismName == _prsAppealCheckAndSubmitViewModel.SpecialismName &&
                      x.SpecialismLarId == _prsAppealCheckAndSubmitViewModel.SpecialismLarId &&
