...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.PostResultsServiceControllerTests.PrsAppealOutcomePathwayGradePost
{
    public class When_ModelState_Invalid : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            ViewModel = new AppealOutcomePathwayGradeViewModel { ProfileId = 1, PathwayAssessmentId = AssessmentId, PathwayResultId = ResultId, AppealOutcome = null };
            Controller.ModelState.AddModelError("AppealOutcome", Content.PostResultsService.AppealOutcomePathwayGrade.Validation_Message); ;
        }
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            viewResult.Model.Should().BeOfType(typeof(AppealOutcomePathwayGradeViewModel));
            ...
            Controller.ViewData.ModelState.ContainsKey(nameof(AppealOutcomePathwayGradeViewModel.AppealOutcome)).Should().BeTrue();

            var modelState = Controller.ViewData.ModelState[nameof(AppealOutcomePathwayGradeViewModel.AppealOutcome)];
            modelState.Errors[0].ErrorMessage.Should().Be(Content.PostResultsService.AppealOutcomePathwayGrade.Validation_Message);
        }
    }
}
