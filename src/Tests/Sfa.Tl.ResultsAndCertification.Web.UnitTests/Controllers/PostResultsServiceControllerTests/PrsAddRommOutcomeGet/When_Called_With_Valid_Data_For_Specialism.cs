...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.PostResultsServiceControllerTests.PrsAddRommOutcomeGet
{
    public class When_Called_With_Valid_Data_For_Specialism : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            model.SpecialismName.Should().Be(_addRommOutcomeViewModel.SpecialismName);
            model.SpecialismLarId.Should().Be(_addRommOutcomeViewModel.SpecialismLarId);
            model.SpecialismDisplayName.Should().Be($"{_addRommOutcomeViewModel.SpecialismName} ({_addRommOutcomeViewModel.SpecialismLarId})");
