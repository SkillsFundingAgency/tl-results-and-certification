...
{
    public class When_Grades_AreNotSame_For_Core : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            model.BackLink.RouteName.Should().Be(RouteConstants.PrsAppealGradeChange);
            model.BackLink.RouteAttributes.Count.Should().Be(5);
            ...
            model.BackLink.RouteAttributes.TryGetValue(Constants.IsAppealOutcomeJourney, out string routeAppealOutcomeJourney);
            routeAppealOutcomeJourney.Should().Be("false");
            model.BackLink.RouteAttributes.TryGetValue(Constants.IsChangeMode, out string routeIsChangeMode);
            routeIsChangeMode.Should().Be("false");
        }
