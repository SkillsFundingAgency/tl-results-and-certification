...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.PostResultsServiceControllerTests.PrsAppealCheckAndSubmitGet
{
    ...
    {
        private readonly PrsAppealCheckAndSubmitViewModel _mockCache = null;

        public override void Given()
        {
            CacheService.GetAndRemoveAsync<PrsAppealCheckAndSubmitViewModel>(CacheKey).Returns(_mockCache);
        }
