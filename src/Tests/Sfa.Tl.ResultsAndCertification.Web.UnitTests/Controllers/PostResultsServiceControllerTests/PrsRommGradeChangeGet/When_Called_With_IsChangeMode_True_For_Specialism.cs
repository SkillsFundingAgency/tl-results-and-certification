...
{
    public class When_Called_With_IsChangeMode_True_For_Specialism : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            model.SpecialismDisplayName.Should().Be(_rommGradeChangeViewModel.SpecialismDisplayName);
