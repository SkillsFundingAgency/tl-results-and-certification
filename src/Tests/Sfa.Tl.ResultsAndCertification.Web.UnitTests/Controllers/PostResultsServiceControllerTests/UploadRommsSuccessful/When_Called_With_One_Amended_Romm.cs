...
{
    public class When_Called_With_One_Amended_Romm : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            model.SuccessfulRommText.Should().Be(string.Format(RommContent.UploadRommsSuccessful.Successfully_Sent_Amended_Romms_Singular_Text, UploadSuccessfulViewModel.Stats.AmendedRecordsCount));
        }
    }
}
