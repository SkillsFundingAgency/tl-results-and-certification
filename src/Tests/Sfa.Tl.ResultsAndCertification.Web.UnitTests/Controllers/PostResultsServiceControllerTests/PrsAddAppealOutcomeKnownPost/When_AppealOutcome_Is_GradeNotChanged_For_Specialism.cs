...
{
    public class When_AppealOutcome_Is_GradeNotChanged_For_Specialism : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            _checkAndSubmitViewModel = new PrsAppealCheckAndSubmitViewModel { OldGrade = "Pass", GradeCode = "SCG3", };
