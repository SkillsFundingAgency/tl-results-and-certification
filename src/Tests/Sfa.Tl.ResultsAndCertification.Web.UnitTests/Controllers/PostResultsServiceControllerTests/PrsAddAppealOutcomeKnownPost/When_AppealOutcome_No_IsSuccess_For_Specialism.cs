...
{
    public class When_AppealOutcome_No_IsSuccess_For_Specialism : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            _expectedSuccessBannerMsg = string.Format(PrsAddAppealOutcomeKnownContent.Banner_Message, ViewModel.LearnerName, ViewModel.ExamPeriod, ViewModel.SpecialismDisplayName);
        }
        ...
        public void Then_Expected_Methods_AreCalled()
        {
            ...
            CacheService.Received(1).SetAsync(CacheKey, Arg.Is<NotificationBannerModel>(x => x.DisplayMessageBody == true && x.HeaderMessage.Equals(_expectedHeaderMsg) && x.Message.Equals(_expectedSuccessBannerMsg)), CacheExpiryTime.XSmall);
        }
