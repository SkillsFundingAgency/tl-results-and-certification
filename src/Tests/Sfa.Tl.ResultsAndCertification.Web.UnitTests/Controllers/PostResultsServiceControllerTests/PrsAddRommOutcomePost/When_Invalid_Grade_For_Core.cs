...
{
    public class When_Invalid_Grade_For_Core : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            ViewModel = new PrsAddRommOutcomeViewModel { ProfileId = 1, AssessmentId = 11, RommOutcome = RommOutcomeType.GradeChanged, ComponentType = ComponentType };
