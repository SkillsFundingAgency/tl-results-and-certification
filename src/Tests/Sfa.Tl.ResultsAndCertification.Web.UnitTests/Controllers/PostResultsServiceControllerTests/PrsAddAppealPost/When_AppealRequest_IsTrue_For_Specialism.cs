...
{
    public class When_AppealRequest_IsTrue_For_Specialism : TestSetup
    {
        public override void Given()
        {
            ViewModel = new PrsAddAppealViewModel { ProfileId = 1, AssessmentId = 11, ComponentType = ComponentType.Specialism, IsAppealRequested = true, AppealEndDate = DateTime.Today.AddDays(7) };
            Loader.GetPrsLearnerDetailsAsync<PrsAddAppealViewModel>(AoUkprn, ProfileId, AssessmentId, ComponentType.Specialism).Returns(ViewModel);
        }
