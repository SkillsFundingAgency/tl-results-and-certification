...
{
    public class When_RommRequest_IsTrue_For_Specialism : TestSetup
    {
        public override void Given()
        {
            ViewModel = new PrsAddRommViewModel { ProfileId = 1, AssessmentId = 11, ComponentType = ComponentType.Specialism, IsRommRequested = true, RommEndDate = DateTime.Today.AddDays(7) };
