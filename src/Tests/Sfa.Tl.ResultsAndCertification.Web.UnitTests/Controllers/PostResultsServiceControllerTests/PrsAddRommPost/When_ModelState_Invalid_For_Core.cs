...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.PostResultsServiceControllerTests.PrsAddRommPost
{
    public class When_ModelState_Invalid_For_Core : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            ViewModel = new PrsAddRommViewModel { ProfileId = 1, AssessmentId = AssessmentId, ComponentType = ComponentType, IsRommRequested = null };
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            model.CoreName.Should().Be(_addRommCoreGradeViewModel.CoreName);
            model.CoreLarId.Should().Be(_addRommCoreGradeViewModel.CoreLarId);
            model.CoreDisplayName.Should().Be($"{_addRommCoreGradeViewModel.CoreName} ({_addRommCoreGradeViewModel.CoreLarId})");
