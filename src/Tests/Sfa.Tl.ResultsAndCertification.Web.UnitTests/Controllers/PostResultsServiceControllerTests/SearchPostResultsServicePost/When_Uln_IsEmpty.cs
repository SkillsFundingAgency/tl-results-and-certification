...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.PostResultsServiceControllerTests.SearchPostResultsServicePost
{
    public class When_Uln_IsEmpty : TestSetup
    {
        ...
        {
            ViewModel = new SearchPostResultsServiceViewModel { SearchUln = string.Empty };
            Controller.ModelState.AddModelError("SearchUln", SearchPostResultsServiceContent.Uln_Required_Validation_Message);
        }
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            modelState.Errors[0].ErrorMessage.Should().Be(SearchPostResultsServiceContent.Uln_Required_Validation_Message);
        }
    }
}