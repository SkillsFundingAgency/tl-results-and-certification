...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.PostResultsServiceControllerTests.PrsRommCheckAndSubmitGet
{
    ...
    {
        private readonly PrsRommCheckAndSubmitViewModel _mockCache = null;

        public override void Given()
        {
            CacheService.GetAndRemoveAsync<PrsRommCheckAndSubmitViewModel>(CacheKey).Returns(_mockCache);
        }
