...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminDashboardControllerTests.RemoveAssessmentEntrySpecialismPost
{
    public abstract class TestSetup : AdminDashboardControllerTestBase
    {
        ...
        protected static AdminRemoveSpecialismAssessmentEntryViewModel CreateViewModel(bool? doYouWantToRemoveThisAssessmentEntry = null)
            => new()
            {
                ...
                DoYouWantToRemoveThisAssessmentEntry = doYouWantToRemoveThisAssessmentEntry
            };
    }
}
