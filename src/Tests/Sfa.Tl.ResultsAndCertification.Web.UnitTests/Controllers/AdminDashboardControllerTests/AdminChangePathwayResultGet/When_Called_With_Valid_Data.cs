...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminDashboardControllerTests.AdminChangePathwayResultGet
{
    public class When_Called_With_Valid_Data : TestSetup
    {
        ...
        {
            CacheService.GetAsync<AdminChangePathwayResultViewModel>(CacheKey).Returns(null as AdminChangePathwayResultViewModel);
            AdminDashboardLoader.GetAdminChangePathwayResultAsync(RegistrationPathwayId, AssessmentId).Returns(ViewModel);
        }
