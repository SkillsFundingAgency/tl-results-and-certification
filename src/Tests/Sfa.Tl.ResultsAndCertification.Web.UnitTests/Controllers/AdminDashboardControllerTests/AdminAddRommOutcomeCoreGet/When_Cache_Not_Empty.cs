...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminDashboardControllerTests.AdminAddRommOutcomeCoreGet
{
    public class When_Cache_Not_Empty : TestSetup
    {
        ...
        {
            CacheService.GetAsync<AdminAddRommOutcomeCoreViewModel>(CacheKey).Returns(ViewModel);
        }
        ...
        public void Then_Expected_Methods_AreCalled()
        {
            ...
            AdminDashboardLoader.DidNotReceive().GetAdminAddRommOutcomeCoreAsync(RegistrationPathwayId, AssessmentId);
        }
