...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminDashboardControllerTests.AdminReviewRemoveSpecialismAssessmentEntryGet
{
    public class When_Called_With_Valid_Data : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            AdminRemoveSpecialismAssessmentEntryViewModel RemoveSpecialismAssessmentEntryViewModel = new()
            {
                Learner = "John Smith",
            ...
            Mockresult = new AdminReviewRemoveSpecialismAssessmentEntryViewModel
            {
                ...
                PathwayAssessmentViewModel = RemoveSpecialismAssessmentEntryViewModel
            };

            CacheService.GetAsync<AdminRemoveSpecialismAssessmentEntryViewModel>(CacheKey).Returns(RemoveSpecialismAssessmentEntryViewModel);
        }
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            var model = (Result as ViewResult).Model as AdminReviewRemoveSpecialismAssessmentEntryViewModel;
            ...
            // AssessmentYear
            model.SummaryAssessmentYear.Title.Should().Be(string.Format(AdminReviewRemoveAssessmentEntry.Label_Occupational_Specialism, model.PathwayAssessmentViewModel.SpecialismName));
            ...
            model.SummaryAssessmentYear.RouteName.Should().Be(RouteConstants.RemoveAssessmentSpecialismEntry);

            // Back link
            model.BackLink.Should().NotBeNull();
            model.BackLink.RouteName.Should().Be(RouteConstants.RemoveAssessmentSpecialismEntry);
        }
    }
}
