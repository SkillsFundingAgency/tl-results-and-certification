...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminDashboardControllerTests.AdminAddPathwayResultGet
{
    public abstract class TestSetup : AdminDashboardControllerTestBase
    {
        ...
        {
            Result = await Controller.AdminAddPathwayResultAsync(RegistrationPathwayId, AssessmentId);
        }

        protected static AdminAddPathwayResultViewModel ViewModel
            => new()
            {
