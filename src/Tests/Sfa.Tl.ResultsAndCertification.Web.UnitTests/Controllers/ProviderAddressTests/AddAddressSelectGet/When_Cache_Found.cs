...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.ProviderAddressTests.AddAddressSelectGet
{
    public class When_Cache_Found : TestSetup
    {
        ...
        private AddAddressSelectViewModel _addressSelectViewModel = null;
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            model.SelectedAddressUprn.Should().Be(_addressSelectViewModel.SelectedAddressUprn);
            model.DepartmentName.Should().Be(_addressSelectViewModel.DepartmentName);
            model.Postcode.Should().Be(_addressSelectViewModel.Postcode);
