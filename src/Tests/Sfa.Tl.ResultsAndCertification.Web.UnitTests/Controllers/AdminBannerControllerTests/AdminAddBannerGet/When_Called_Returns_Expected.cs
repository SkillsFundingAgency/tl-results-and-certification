...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminBannerControllerTests.AdminAddBannerrGet
{
    public class When_Called_Returns_Expected : AdminBannerControllerBaseTest
    {
        ...
        {
            _result = Controller.AdminAddBannerAsync();
        ...
        {
            var viewModel = _result.ShouldBeViewResult<AdminAddBannerViewModel>();

            viewModel.Title.Should().BeNull();
            viewModel.Content.Should().BeNull();
            viewModel.Target.Should().Be(BannerTarget.NotSpecified);
