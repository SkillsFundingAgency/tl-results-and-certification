...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.IndustryPlacementControllerTests.IpMultiEmployerUsedPost
{
    public class When_IsChangeMode_With_Option_Changed_To_No : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            ViewModel = new IpMultiEmployerUsedViewModel { IsMultiEmployerModelUsed = false, IsChangeMode = true };
        ...
        [Fact]
        public void Then_Redirected_To_IpMultiEmployerOther()
        {
            var routeName = (Result as RedirectToRouteResult).RouteName;
            routeName.Should().Be(RouteConstants.IpMultiEmployerSelect);
        }
    }
}
