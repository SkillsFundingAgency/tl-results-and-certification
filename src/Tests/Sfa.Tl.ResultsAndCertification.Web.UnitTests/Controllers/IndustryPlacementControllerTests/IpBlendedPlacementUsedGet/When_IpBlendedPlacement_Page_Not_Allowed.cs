...
{
    public class When_IpBlendedPlacement_Page_Not_Allowed : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            // Loader navigation
            _ipTempFlexNavigation = new IpTempFlexNavigation { AskBlendedPlacement = false, AskTempFlexibility = true };
