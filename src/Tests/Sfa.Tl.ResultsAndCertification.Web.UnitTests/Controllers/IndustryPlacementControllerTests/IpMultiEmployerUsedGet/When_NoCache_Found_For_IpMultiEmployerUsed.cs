...
{
    public class When_NoCache_Found_For_IpMultiEmployerUsed : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            _ipMultiEmployerUsedViewModel = new IpMultiEmployerUsedViewModel { LearnerName = _ipCompletionViewModel.LearnerName };
        ...
        {
            IndustryPlacementLoader.Received(1).TransformIpCompletionDetailsTo<IpMultiEmployerUsedViewModel>(_cacheResult.IpCompletion);
        }
