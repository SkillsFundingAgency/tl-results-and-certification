...
{
    public class When_TempFlexibilityUsed_And_BlendedPlacement_Is_True : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            ViewModel = new IpBlendedPlacementUsedViewModel { LearnerName = _ipCompletionViewModel.LearnerName, IsBlendedPlacementUsed = true };
        }
        ...
        public void Then_Redirected_To_Expected_Route()
        {
            ...
            actualRouteName.Should().Be(RouteConstants.IpEmployerLedUsed);
        }
    }
}
