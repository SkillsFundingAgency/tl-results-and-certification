...
{
    public class When_IpMultiEmployerUsed_Is_Yes : TestSetup
    {
        ...
        {
            IndustryPlacementLoader.DidNotReceive().GetIpLookupDataAsync<IpMultiEmployerSelectViewModel>(Arg.Any<IpLookupType>(), Arg.Any<string>(), Arg.Any<int?>(), Arg.Any<bool>());
        }
