...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.IndustryPlacementControllerTests.IpTempFlexibilityUsedGet
{
    public class When_Called_With_Valid_Data_Without_Cache : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            IndustryPlacementLoader.TransformIpCompletionDetailsTo<IpTempFlexibilityUsedViewModel>(_cacheResult.IpCompletion).Returns(_ipTempFlexibilityUsedViewModel);
        }
        ...
        public void Then_Expected_Methods_AreCalled()
        {
            ...
            IndustryPlacementLoader.Received(1).TransformIpCompletionDetailsTo<IpTempFlexibilityUsedViewModel>(_cacheResult.IpCompletion);
        }
