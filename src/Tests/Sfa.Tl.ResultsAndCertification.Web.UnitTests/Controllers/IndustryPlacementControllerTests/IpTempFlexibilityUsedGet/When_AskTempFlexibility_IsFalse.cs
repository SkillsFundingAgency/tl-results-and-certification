...
{
    public class When_AskTempFlexibility_IsFalse : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            // Loader navigation
            _ipTempFlexNavigation = new IpTempFlexNavigation { AskBlendedPlacement = true, AskTempFlexibility = false };
        ...
        [Fact]
        public void Then_Redirected_To_IpBlendedPlacementUsed()
        {
