...
{
    public class When_IpCompletion_IsChangeMode_IsTrue : TestSetup
    {
        ...
        {
            _ipCompletionViewModel = new IpCompletionViewModel { ProfileId = 1, AcademicYear = 2020, LearnerName = "First Last", IsChangeMode = true, IndustryPlacementStatus = IndustryPlacementStatus.CompletedWithSpecialConsideration };
