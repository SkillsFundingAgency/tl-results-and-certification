...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.ManageRegistrationControllerTests.ReregisterSpecialismsGet
{
    public class When_IsChangeMode_True : TestSetup
    {
        ...
        private string _selectedSpecialismCode = "12345678";
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            model.IsChangeModeFromSpecialismQuestion.Should().BeTrue(); 
            ...
            backLink.RouteAttributes.TryGetValue(Constants.IsChangeMode, out string isChangeModeParam);
            isChangeModeParam.Should().Be("true");
        }
    }
}
