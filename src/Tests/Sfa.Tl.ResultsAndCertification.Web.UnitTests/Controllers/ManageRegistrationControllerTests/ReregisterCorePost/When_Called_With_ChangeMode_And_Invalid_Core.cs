...
{
    public class When_Called_With_ChangeMode_And_Invalid_Core : TestSetup
    {
        ...
        {
            IsChangeMode = true;
            ViewModel = new ReregisterCoreViewModel { ProfileId = ProfileId, SelectedCoreCode = _coreCodeAtTheTimeOfWithdrawn, IsChangeMode = true, CoreCodeAtTheTimeOfWithdrawn = _coreCodeAtTheTimeOfWithdrawn };
