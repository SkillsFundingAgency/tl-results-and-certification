...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.ManageRegistrationControllerTests.ReregistrationConfirmationGet
{
    public abstract class TestSetup : BaseTest<ManageRegistrationController>
    {
        ...
        protected ReregistrationResponse MockResult;
        ...
        public override void Setup()
        {
            ...
            MockResult = new ReregistrationResponse { Uln = 123456789, ProfileId = 1 };
        }

        public async override Task When()
        {
            Result = await Controller.ReregistrationConfirmationAsync();
        }
    }
}
