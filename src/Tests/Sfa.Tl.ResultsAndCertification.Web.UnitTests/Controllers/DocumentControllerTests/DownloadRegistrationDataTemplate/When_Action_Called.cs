...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.DocumentControllerTests.DownloadRegistrationDataTemplateAsync
{
    public class When_Action_Called : TestSetup
    {
        ...
        {
            _fileName = DocumentResource.TlevelDataFormatAndRulesGuide.Tlevels_Registration_Data_Template_File_Name;
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            viewResult.FileDownloadName.Should().Be(DocumentResource.TlevelDataFormatAndRulesGuide.Tlevels_Registration_Data_Template_File_Name);
