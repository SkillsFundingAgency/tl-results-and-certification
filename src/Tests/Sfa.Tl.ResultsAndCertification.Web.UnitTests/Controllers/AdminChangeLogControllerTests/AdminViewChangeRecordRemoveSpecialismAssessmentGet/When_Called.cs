...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminChangeLogControllerTests.AdminViewChangeRecordRemoveSpecialismAssessmentGet
{
    public class When_Called : AdminChangeLogControllerTestBase
    {
        private IActionResult Result;

        private AdminViewChangeRecordRemoveSpecialismAssessmentViewModel Mockresult;
        private DetailsSpecialismAssessmentRemove details;

        public override void Given()
        {
            details = new()
            {
                SpecialismName = "Data Technician (ZTLOS009)",
                From = "Summer 2023",
            ...
            AdminChangeLogLoader.GetAdminViewChangeRemoveSpecialismAssessmentRecord(ChangeLogId).Returns(Mockresult);
        }

        public override async Task When()
        => Result = await Controller.AdminViewChangeRecordRemoveSpecialismAssessmentAsync(ChangeLogId);

        [Fact]
        public void Then_Expected_Methods_AreCalled()
        {
            AdminChangeLogLoader.Received(1).GetAdminViewChangeRemoveSpecialismAssessmentRecord(ChangeLogId);
        }
        ...
        public void Then_Return_Expected_Results()
        {
            ...
            var model = (Result as ViewResult).Model as AdminViewChangeRecordRemoveSpecialismAssessmentViewModel;
            ...
            model.DetailsChangeAssessment.SpecialismName.Should().Be(Mockresult.DetailsChangeAssessment.SpecialismName);
        ...
        protected AdminViewChangeRecordRemoveSpecialismAssessmentViewModel CreateViewModel() => new()
        {
            ...
            ChangeType = Common.Enum.ChangeType.RemoveSpecialismAssessment,
        };
    }
}