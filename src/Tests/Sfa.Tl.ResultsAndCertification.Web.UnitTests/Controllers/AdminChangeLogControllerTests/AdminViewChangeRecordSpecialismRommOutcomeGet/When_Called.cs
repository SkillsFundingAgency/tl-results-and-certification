...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminChangeLogControllerTests.AdminViewChangeRecordSpecialismRommOutcomeGet
{
    public class When_Called : AdminChangeLogControllerTestBase
    {
        private IActionResult Result;

        private AdminViewChangeRecordSpecialismRommOutcomeViewModel Mockresult;
        private SpecialismRommOutcomeDetails details;

        public override void Given()
        {
            details = new()
            {
                SpecialismResultId = 2888359,
                From = "Merit",
                To = "Distinction",
            ...
            AdminChangeLogLoader.GetAdminViewChangeSpecialismRommOutcomeRecord(ChangeLogId).Returns(Mockresult);
        }

        public override async Task When()
            => Result = await Controller.AdminViewChangeRecordSpecialismRommOutcomeAsync(ChangeLogId);

        [Fact]
        public void Then_Expected_Methods_AreCalled()
        {
            AdminChangeLogLoader.Received(1).GetAdminViewChangeSpecialismRommOutcomeRecord(ChangeLogId);
        }
        ...
        public void Then_Return_Expected_Results()
        {
            ...
            var model = (Result as ViewResult).Model as AdminViewChangeRecordSpecialismRommOutcomeViewModel;
            ...
            model.RommOutcomeDetails.SpecialismResultId.Should().Be(Mockresult.RommOutcomeDetails.SpecialismResultId);
            ...
            model.RommOutcomeDetails.SpecialismAssessmentId.Should().Be(Mockresult.RommOutcomeDetails.SpecialismAssessmentId);
        ...
        protected AdminViewChangeRecordSpecialismRommOutcomeViewModel CreateViewModel() => new()
        {
            ...
            ChangeType = Common.Enum.ChangeType.SpecialismRommOutcome
        };
    }
}