...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminChangeLogControllerTests.AdminViewChangeRecordStartYearGet
{
    public class When_Called : AdminChangeLogControllerTestBase
    {
        private IActionResult Result;
        private AdminViewChangeRecordStartYearViewModel Mockresult;
        private ChangeStartYearDetails details;
        ...
        public override void Given()
        {
            ...
            AdminChangeLogLoader.GetAdminViewChangeStartYearRecord(ChangeLogId).Returns(Mockresult);
        }

        public override async Task When()
        {
            Result = await Controller.AdminViewChangeRecordStartYearAsync(ChangeLogId);
        }
        ...
        public void Then_Expected_Methods_AreCalled()
            => AdminChangeLogLoader.Received(1).GetAdminViewChangeStartYearRecord(ChangeLogId);
        ...
        public void Then_Return_Expected_Results()
        {
            ...
            var model = (Result as ViewResult).Model as AdminViewChangeRecordStartYearViewModel;
            ...
            model.ChangeStartYearDetails.StartYearFrom.Should().Be(Mockresult.ChangeStartYearDetails.StartYearFrom);
            model.ChangeStartYearDetails.StartYearTo.Should().Be(Mockresult.ChangeStartYearDetails.StartYearTo);
        ...
        private AdminViewChangeRecordStartYearViewModel CreateViewModel() => new()
        {
            ...
            ChangeStartYearDetails = details,
            ChangeType = Common.Enum.ChangeType.StartYear
        };
    }
}