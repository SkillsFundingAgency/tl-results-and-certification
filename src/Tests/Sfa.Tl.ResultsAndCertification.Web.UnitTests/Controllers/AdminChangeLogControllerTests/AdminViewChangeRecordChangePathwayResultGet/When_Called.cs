...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminChangeLogControllerTests.AdminViewChangeRecordChangePathwayResultGet
{
    public class When_Called : AdminChangeLogControllerTestBase
    {
        private IActionResult Result;

        private AdminViewChangeRecordPathwayResultViewModel Mockresult;
        private ChangePathwayDetails details;
        ...
        public override void Given()
        {
            ...
            AdminChangeLogLoader.GetAdminViewChangePathwayResultRecord(ChangeLogId).Returns(Mockresult);
        }

        public override async Task When()
            => Result = await Controller.AdminViewChangeRecordChangePathwayResultAsync(ChangeLogId);

        [Fact]
        public void Then_Expected_Methods_AreCalled()
        {
            AdminChangeLogLoader.Received(1).GetAdminViewChangePathwayResultRecord(ChangeLogId);
        }
        ...
        public void Then_Return_Expected_Results()
        {
            ...
            var model = (Result as ViewResult).Model as AdminViewChangeRecordPathwayResultViewModel;
            ...
            model.PathwayResultDetails.PathwayAssessmentId.Should().Be(Mockresult.PathwayResultDetails.PathwayAssessmentId);
            model.PathwayResultDetails.PathwayResultId.Should().Be(Mockresult.PathwayResultDetails.PathwayResultId);
            model.PathwayResultDetails.SelectedGradeFrom.Should().Be(Mockresult.PathwayResultDetails.SelectedGradeFrom);
            model.PathwayResultDetails.SelectedGradeTo.Should().Be(Mockresult.PathwayResultDetails.SelectedGradeTo);
        ...
        protected AdminViewChangeRecordPathwayResultViewModel CreateViewModel() => new()
        {
