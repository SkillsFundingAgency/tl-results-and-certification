...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminChangeLogControllerTests.AdminViewChangeRecordAddPathwayResultGet
{
    public class When_Called : AdminChangeLogControllerTestBase
    {
        private IActionResult Result;

        private AdminViewChangeRecordAddPathwayResultViewModel Mockresult;
        private AddPathwayResultRequest details;
        ...
        public override void Given()
        {
            ...
            AdminChangeLogLoader.GetAdminViewChangeAddPathwayResultRecord(ChangeLogId).Returns(Mockresult);
        }

        public override async Task When()
            => Result = await Controller.AdminViewChangeRecordAddPathwayResultAsync(ChangeLogId);

        [Fact]
        public void Then_Expected_Methods_AreCalled()
        {
            AdminChangeLogLoader.Received(1).GetAdminViewChangeAddPathwayResultRecord(ChangeLogId);
        }
        ...
        public void Then_Return_Expected_Results()
        {
            ...
            var model = (Result as ViewResult).Model as AdminViewChangeRecordAddPathwayResultViewModel;
            ...
            model.PathwayResultDetails.GradeTo.Should().Be(Mockresult.PathwayResultDetails.GradeTo);
        ...
        protected AdminViewChangeRecordAddPathwayResultViewModel CreateViewModel() => new()
        {
            ...
            ChangeType = Common.Enum.ChangeType.AddPathwayResult
        };
    }
}