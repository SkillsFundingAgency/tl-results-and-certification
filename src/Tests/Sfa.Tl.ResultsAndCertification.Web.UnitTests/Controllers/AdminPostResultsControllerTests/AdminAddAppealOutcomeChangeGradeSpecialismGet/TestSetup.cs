...

{
    public abstract class TestSetup : AdminPostResultsControllerTestBase
    {
        ...
        {
            Result = await Controller.AdminAddAppealOutcomeChangeGradeSpecialismAsync(RegistrationPathwayId, AssessmentId);
        }

        protected static AdminAddAppealOutcomeChangeGradeSpecialismViewModel ViewModel
            => new()
            {
