...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminPostResultsControllerTests.AdminAddSpecialismRommOutcomePost
{
    public class When_ModelState_Invalid : TestSetup
    {
        ...
        private const string ErrorKey = "AdminAddSpecialismRommOutcome";

        public override void Given()
        {
            _viewModel = CreateViewModel();
            Controller.ModelState.AddModelError(ErrorKey, AdminAddSpecialismRommOutcome.Validation_Message);
        }
        ...
        {
            var model = Result.ShouldBeViewResult<AdminAddSpecialismRommOutcomeViewModel>();
            ...
            modelState[ErrorKey].Errors[0].ErrorMessage.Should().Be(AdminAddSpecialismRommOutcome.Validation_Message);
        }
    }
}