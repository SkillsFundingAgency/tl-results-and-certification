...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminPostResultsControllerTests.AdminReviewSpecialismAppealChangesPost
{
    public class When_Process_Ok : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            AdminPostResultsLoader.ProcessAdminOpenSpecialismAppealAsync(_viewModel).Returns(true);
        }
        ...
        public void Then_Expected_Methods_AreCalled()
        {
            CacheService.Received(1).SetAsync<NotificationBannerModel>(
                ...
                Arg.Is<AdminNotificationBannerModel>(p => p.Message.Contains(AdminReviewSpecialismAppealChanges.Notification_Message_Specialism_Appeal_Added)),
