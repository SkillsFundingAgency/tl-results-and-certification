...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminPostResultsControllerTests.AdminReviewCoreAppealChangesPost
{
    public class When_Process_Ok : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            AdminPostResultsLoader.ProcessAdminOpenCoreAppealAsync(_viewModel).Returns(true);
        }
        ...
        public void Then_Expected_Methods_AreCalled()
        {
            CacheService.Received(1).SetAsync<NotificationBannerModel>(
                ...
                Arg.Is<AdminNotificationBannerModel>(p => p.Message.Contains(AdminReviewCoreAppealChanges.Notification_Message_Core_Appeal_Added)),
