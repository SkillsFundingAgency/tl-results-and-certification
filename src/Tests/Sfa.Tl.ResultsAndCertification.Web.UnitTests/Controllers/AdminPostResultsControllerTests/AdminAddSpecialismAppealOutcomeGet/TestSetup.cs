...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminPostResultsControllerTests.AdminAddSpecialismAppealOutcomeGet
{
    public abstract class TestSetup : AdminPostResultsControllerTestBase
    {
        ...
        {
            Result = await Controller.AdminAddSpecialismAppealOutcomeAsync(RegistrationPathwayId, SpecialismAssessmentId);
        }

        protected static AdminAddSpecialismAppealOutcomeViewModel CreateViewModel()
            => new()
            {
