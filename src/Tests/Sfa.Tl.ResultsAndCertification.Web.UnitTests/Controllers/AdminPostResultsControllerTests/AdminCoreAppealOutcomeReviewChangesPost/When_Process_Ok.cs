...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminPostResultsControllerTests.AdminCoreAppealOutcomeReviewChangesPost
{
    public class When_Process_Ok : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            AdminPostResultsLoader.ProcessAdminReviewChangesAppealOutcomeCoreAsync(_viewModel).Returns(true);
        }
        ...
        public void Then_Expected_Methods_AreCalled()
        {
            CacheService.Received(1).SetAsync<NotificationBannerModel>(
                ...
                Arg.Is<AdminNotificationBannerModel>(p => p.Message.Contains(AdminReviewChangesAppealOutcomeCore.Notification_Message_Appeal_Outcome_Added)),
