...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminPostResultsControllerTests.AdminAddCoreRommOutcomeAsync
{
    public abstract class TestSetup : AdminPostResultsControllerTestBase
    {
        ...
        {
            Result = await Controller.AdminAddCoreRommOutcomeAsync(RegistrationPathwayId, PathwayAssessmentId);
        }

        protected static AdminAddCoreRommOutcomeViewModel CreateViewModel()
            => new()
            {
