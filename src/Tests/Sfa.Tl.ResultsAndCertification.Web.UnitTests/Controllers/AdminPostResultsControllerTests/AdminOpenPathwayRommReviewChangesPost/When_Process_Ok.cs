...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminPostResultsControllerTests.AdminOpenPathwayRommReviewChangesPost
{
    public class When_Process_Ok : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            AdminPostResultsLoader.ProcessAdminOpenPathwayRommAsync(_viewModel).Returns(true);
        }
        ...
        public void Then_Expected_Methods_AreCalled()
        {
            CacheService.Received(1).SetAsync<NotificationBannerModel>(
                ...
                Arg.Is<AdminNotificationBannerModel>(p => p.Message.Contains(AdminOpenPathwayRommReviewChanges.Notification_Message_A_Romm_Has_Been_Opened)),
