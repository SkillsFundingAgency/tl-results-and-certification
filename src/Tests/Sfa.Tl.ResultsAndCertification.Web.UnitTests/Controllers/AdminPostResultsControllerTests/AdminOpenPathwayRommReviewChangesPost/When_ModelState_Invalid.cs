...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminPostResultsControllerTests.AdminOpenPathwayRommReviewChangesPost
{
    public class When_ModelState_Invalid : TestSetup
    {
        ...
        private const string ErrorKey = "AdminOpenPathwayRommReviewChanges";
        ...
        public override void Given()
        {
            ...
            Controller.ModelState.AddModelError(ErrorKey, AdminOpenPathwayRommReviewChanges.Validation_Message);
        }
        ...
        {
            var model = _result.ShouldBeViewResult<AdminOpenPathwayRommReviewChangesViewModel>();
            ...
            modelState[ErrorKey].Errors[0].ErrorMessage.Should().Be(AdminOpenPathwayRommReviewChanges.Validation_Message);
        }
    }
}