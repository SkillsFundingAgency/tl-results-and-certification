...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.AdminPostResultsControllerTests.AdminAddCoreAppealOutcomeGet
{
    public abstract class TestSetup : AdminPostResultsControllerTestBase
    {
        ...
        {
            Result = await Controller.AdminAddCoreAppealOutcomeAsync(RegistrationPathwayId, PathwayAssessmentId);
        }

        protected static AdminAddCoreAppealOutcomeViewModel CreateViewModel()
            => new()
            {
