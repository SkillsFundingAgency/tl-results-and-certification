...
{
    public abstract class When_AddRegistrationDateofBirth_Get_Action_Is_Called : BaseTest<RegistrationController>
    {
        ...
        {
            Result = Controller.AddRegistrationDateofBirthAsync(IsChangeMode).Result;
        }
    }
}
