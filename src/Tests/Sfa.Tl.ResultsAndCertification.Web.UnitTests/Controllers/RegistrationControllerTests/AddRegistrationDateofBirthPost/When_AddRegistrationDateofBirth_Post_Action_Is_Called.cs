...
{
    public abstract class When_AddRegistrationDateofBirth_Post_Action_Is_Called : BaseTest<RegistrationController>
    {
        ...
        {
            Result = Controller.AddRegistrationDateofBirthAsync(DateofBirthViewmodel).Result;
        }
    }
}
