...
{
    public abstract class When_AddRegistrationAcademicYear_Action_Is_Called : BaseTest<RegistrationController>
    {
        protected int Ukprn;
        ...
        protected SelectAcademicYearViewModel SelectAcademicYearViewModel;
        ...
        {
            Result = Controller.AddRegistrationAcademicYearAsync(SelectAcademicYearViewModel).Result;
        }
    }
}
