...
{
    public class Then_On_Success_With_Selected_Specialisms_Redirected_To_AddRegistrationCheckAndSubmit_Route : When_AddRegistrationAcademicYear_Action_Is_Called
    {
        ...
        [Fact]
        public void Then_On_Success_With_Selected_Specialisms_Redirected_To_AddRegistration_CheckAndSubmit_Route()
        {
