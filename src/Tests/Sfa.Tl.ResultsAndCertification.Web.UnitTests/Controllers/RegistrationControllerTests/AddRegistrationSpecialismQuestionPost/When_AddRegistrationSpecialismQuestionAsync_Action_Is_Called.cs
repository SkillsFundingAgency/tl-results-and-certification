...
{
    public abstract class When_AddRegistrationSpecialismQuestionAsync_Action_Is_Called : BaseTest<RegistrationController>
    {
        protected int Ukprn;
        ...
        protected SpecialismQuestionViewModel SpecialismQuestionViewModel;
        ...
        {
            Result = Controller.AddRegistrationSpecialismQuestionAsync(SpecialismQuestionViewModel).Result;
        }
    }
}
