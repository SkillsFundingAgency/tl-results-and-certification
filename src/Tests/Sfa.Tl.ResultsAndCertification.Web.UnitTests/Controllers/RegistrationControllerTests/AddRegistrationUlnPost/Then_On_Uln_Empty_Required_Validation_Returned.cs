...
{
    public class Then_On_Uln_Empty_Required_Validation_Returned : When_AddRegistrationUln_Action_Is_Called
    {
        ...
        public void Then_Uln_Required_Validation_Message_Returned()
        {
            ...
            modelStateUln.Errors[0].ErrorMessage.Should().Be(UlnContent.Validation_Uln_Required);
        }
    }
}
