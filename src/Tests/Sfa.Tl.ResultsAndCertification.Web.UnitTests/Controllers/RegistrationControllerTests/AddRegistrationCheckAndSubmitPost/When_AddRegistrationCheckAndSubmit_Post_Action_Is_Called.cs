...
{
    public abstract class When_AddRegistrationCheckAndSubmit_Post_Action_Is_Called : BaseTest<RegistrationController>
    {
        ...
        {
            Result = Controller.SubmitRegistrationCheckAndSubmitAsync().Result;
        }
    }
}
