...
{
    public class Then_On_ModelState_Invalid_Returns_FileSize_Validation_Error : When_UploadRegistrationsFile_Post_Action_Is_Called
    {
        ...
        [Fact]
        public void Then_Expected_Must_Be_FileSize_Error_Message_Is_Returned()
        {
