...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.RegistrationControllerTests.AddRegistrationCheckAndSubmitGet
{
    public class CheckAndSubmitTestDataGenerator : IEnumerable<object[]>
    {
        ...
        private readonly List<object[]> _data = new List<object[]>
        {
               ...
               new object[] { new CheckAndSubmitTestDataModel { RegistrationViewModel = new RegistrationViewModel { Uln = _ulnViewModel, LearnersName = _learnersNameViewModel, DateofBirth = _dateofBirthViewModel, SelectProvider = _selectProviderViewModel, SelectCore = _selectCoreViewModel, SpecialismQuestion = _specialismQuestionViewModel, SelectSpecialisms = _selectSpecialismViewModel }, RouteName = RouteConstants.PageNotFound} },
               new object[] { new CheckAndSubmitTestDataModel { RegistrationViewModel = new RegistrationViewModel { Uln = _ulnViewModel, LearnersName = _learnersNameViewModel, DateofBirth = _dateofBirthViewModel, SelectProvider = _selectProviderViewModel, SelectCore = _selectCoreViewModel, SpecialismQuestion = _specialismQuestionViewModel, SelectSpecialisms = _selectSpecialismViewModel, SelectAcademicYear = null }, RouteName = RouteConstants.PageNotFound} }
        };
