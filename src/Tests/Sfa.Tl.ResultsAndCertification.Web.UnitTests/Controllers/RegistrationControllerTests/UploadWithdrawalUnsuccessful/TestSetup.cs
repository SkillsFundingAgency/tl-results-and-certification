...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.RegistrationControllerTests.UploadWithdrawlUnsuccessful
{
    public abstract class TestSetup : BaseTest<RegistrationController>
    {
        ...
        {
            Result = await Controller.UploadWithdrawalsUnsuccessful();
        }
    }
}
