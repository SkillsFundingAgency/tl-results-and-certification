...
{
    public class Then_Expected_Unchanged_Registrations_Singular_Text_Returned : When_UploadSuccessful_Is_Called
    {
        ...
        [Fact]
        public void Then_Expected_Unchanged_Registrations_Singular_Text_Are_Returned()
        {
