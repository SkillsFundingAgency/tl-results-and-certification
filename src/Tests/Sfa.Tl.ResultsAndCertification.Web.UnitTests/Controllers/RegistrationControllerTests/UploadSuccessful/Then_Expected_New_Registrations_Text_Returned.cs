...
{
    public class Then_Expected_New_Registrations_Text_Returned : When_UploadSuccessful_Is_Called
    {
        ...
        [Fact]
        public void Then_Expected_New_Registrations_Text_Are_Returned()
        {
