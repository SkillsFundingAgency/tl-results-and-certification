...
{
    public abstract class When_AddRegistrationSpecialism_Action_Is_Called : BaseTest<RegistrationController>
    {
        protected int Ukprn;
        ...
        protected SelectSpecialismViewModel SelectSpecialismViewModel;
        ...
        {
            Result = Controller.AddRegistrationSpecialismsAsync(SelectSpecialismViewModel).Result;
        }
    }
}
