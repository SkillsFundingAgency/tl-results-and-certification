...
{
    public class Then_On_ChangeMode_Redirected_To_AddRegistrationSpecialismQuestion_Route : When_AddRegistrationCoreAsync_Action_Is_Called
    {
        ...
        [Fact]
        public void Then_Redirected_To_AddRegistrationSpecialismQuestion_Route()
        {
