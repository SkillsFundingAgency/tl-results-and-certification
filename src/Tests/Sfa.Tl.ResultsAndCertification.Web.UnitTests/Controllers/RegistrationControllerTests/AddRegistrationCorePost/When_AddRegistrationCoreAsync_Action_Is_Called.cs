...
{
    public abstract class When_AddRegistrationCoreAsync_Action_Is_Called : BaseTest<RegistrationController>
    {
        protected int Ukprn;
        ...
        protected SelectCoreViewModel SelectCoreViewModel;
        ...
        {
            Result = Controller.AddRegistrationCoreAsync(SelectCoreViewModel).Result;
        }
    }
}
