...
{
    public class Then_On_ModelState_Invalid_Returns_MaxLength_Validation_Error : When_AddRegistrationLearnersName_Post_Action_Is_Called
    {
        ...
        [Fact]
        public void Then_Expected_MaxLength_Error_Message_Is_Returned()
        {
