    ...
    public class Then_ModelState_Invalid_Returns_Expected_ViewModel : When_SelectProviderTlevelsAsync_Post_Action_Is_Called
    {
        ...
        public override void Given()
        {
            ...
            mockresult = new ProviderTlevelsViewModel
            {
                ...
                {
                    new ProviderTlevelViewModel { TqAwardingOrganisationId = 1, TlProviderId = 1, PathwayId = 1, TlevelTitle = "Route1: Pathway1" },
                    new ProviderTlevelViewModel { TqAwardingOrganisationId = 1, TlProviderId = 1, PathwayId = 2, TlevelTitle = "Route1: Pathway1" }
                }
            };
        ...
        public void Then_On_ModelState_Not_Valid_Expected_ViewModel_Is_Returned()
        {
            ...
            actualFirstItemModel.PathwayId.Should().Be(expectedFirstItemModel.PathwayId);
