    ...
    public class Then_Not_Success_Redirected_To_Error_500 : When_SelectProviderTlevelsAsync_Post_Action_Is_Called
    {
        public override void Given()
        {
            InputViewModel = InputViewModel = new ProviderTlevelsViewModel
            {
                ...
                {
                    new ProviderTlevelDetailsViewModel { TqAwardingOrganisationId = 1, ProviderId = 1, PathwayId = 1, TlevelTitle = "Route1: Pathway1", IsSelected = false },
                    new ProviderTlevelDetailsViewModel { TqAwardingOrganisationId = 1, ProviderId = 1, PathwayId = 2, TlevelTitle = "Route1: Pathway1", IsSelected = false }
                }
            };
