...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.StatementOfAchievementControllerTests.RequestSoaUniqueLearnerNumberPost
{
    public class When_IsLearnerRegistered_IsFalse : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            _soaLearnerRecord = new FindSoaLearnerRecord { Uln = 1234567891, LearnerName = "Test Name", DateofBirth = DateTime.UtcNow.AddYears(-30), ProviderName = "Provider (1234567)", TlevelTitle = "Title", Status = Common.Enum.RegistrationPathwayStatus.Transferred };
