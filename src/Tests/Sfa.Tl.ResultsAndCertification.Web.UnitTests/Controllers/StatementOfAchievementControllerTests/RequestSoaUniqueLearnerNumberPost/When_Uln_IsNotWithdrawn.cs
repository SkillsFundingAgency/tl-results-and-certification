...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.StatementOfAchievementControllerTests.RequestSoaUniqueLearnerNumberPost
{
    public class When_Uln_IsNotWithdrawn : TestSetup
    {
        ...
        private RequestSoaUlnNotWithdrawnViewModel _soaUlnNotWithdrawn = null;
        ...
        public override void Given()
        {
            ...
            _soaUlnNotWithdrawn = new RequestSoaUlnNotWithdrawnViewModel { Uln = 1234567891, LearnerName = "Test Name", DateofBirth = DateTime.UtcNow.AddYears(-30), ProviderName = "Provider (1234567)", TLevelTitle = "Title" };
