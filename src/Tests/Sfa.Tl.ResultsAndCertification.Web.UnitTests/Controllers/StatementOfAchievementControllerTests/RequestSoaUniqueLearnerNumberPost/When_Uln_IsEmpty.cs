...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Controllers.StatementOfAchievementControllerTests.RequestSoaUniqueLearnerNumberPost
{
    public class When_Uln_IsEmpty : TestSetup
    {
        ...
        {
            ViewModel = new RequestSoaUniqueLearnerNumberViewModel { SearchUln = string.Empty };
            Controller.ModelState.AddModelError("SearchUln", RequestSoaUniqueLearnerNumberContent.Uln_Required_Validation_Message);
        }
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            modelState.Errors[0].ErrorMessage.Should().Be(RequestSoaUniqueLearnerNumberContent.Uln_Required_Validation_Message);
        }
    }
}