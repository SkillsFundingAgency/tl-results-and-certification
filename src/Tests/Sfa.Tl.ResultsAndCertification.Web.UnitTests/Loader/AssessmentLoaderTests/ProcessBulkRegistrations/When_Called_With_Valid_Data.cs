...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.AssessmentLoaderTests.ProcessBulkAssessments
{
    public class When_Called_With_Valid_Data : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            ActualResult.Stats.NewRecordsCount.Should().Be(UploadAssessmentsResponseViewModel.Stats.NewRecordsCount);
            ActualResult.Stats.AmendedRecordsCount.Should().Be(UploadAssessmentsResponseViewModel.Stats.AmendedRecordsCount);
            ActualResult.Stats.UnchangedRecordsCount.Should().Be(UploadAssessmentsResponseViewModel.Stats.UnchangedRecordsCount);
        }
    }
}
