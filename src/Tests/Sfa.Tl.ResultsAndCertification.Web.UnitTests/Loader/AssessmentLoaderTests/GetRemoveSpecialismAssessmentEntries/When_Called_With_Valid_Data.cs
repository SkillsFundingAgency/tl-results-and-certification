    ...
    public class When_Called_With_Valid_Data : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            _expectedApiAssessmentEntryDetails = new List<AssessmentEntryDetails>
            {
                ...
                new AssessmentEntryDetails { Uln = 1234567890, ProfileId = 1, AssessmentId = 5, AssessmentSeriesId = 1, AssessmentSeriesName = "Autumn 2021" },
            };
        ...
        public void Then_Expected_Results_Returned()
        {
            ...
            ActualResult.AssessmentSeriesName.Should().Be(_expectedApiAssessmentEntryDetails.FirstOrDefault().AssessmentSeriesName.ToLower());

            ActualResult.SpecialismDisplayName.Should().Be("Specialism 1 (ZT2158963) and Specialism 2 (ZT2158999)");
            ActualResult.IsValidToRemove.Should().BeTrue();
        }
    }
}
