...
{
    public class When_AwardingOrganisation_Returns_Expected : TestSetup
    {
        private readonly LoginUserType _loginUserType = LoginUserType.AwardingOrganisation;
        ...
        public override void Given()
        {
            ...
            var banners = new[]
            {
                "awarding_organisation_banner_content_1",
                "awarding_organisation_banner_content_2"
            };

            ApiClient.GetAwardingOrganisationBanners().Returns(banners);
        }

        [Fact]
        public void Then_Expected_Methods_AreCalled()
        {
            ApiClient.Received(1).GetAwardingOrganisationBanners();
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            {
                new DashboardBannerModel("awarding_organisation_banner_content_1"),
                new DashboardBannerModel("awarding_organisation_banner_content_2")
            };
