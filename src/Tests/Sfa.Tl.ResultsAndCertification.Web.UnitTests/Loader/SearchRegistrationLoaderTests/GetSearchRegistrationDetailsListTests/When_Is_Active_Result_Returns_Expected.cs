...
{
    public class When_Is_Active_Result_Returns_Expected : TestSetup
    {
        public override void Given()
            => Given(SearchRegistrationType.Result, isWithdrawn: false, hasResults: true);
        ...
        public void Then_Returns_Expected()
        {
            ...
            Result.RegistrationDetails[0].Route.RouteName.Should().Be(RouteConstants.ResultDetails);
        }
    }
}