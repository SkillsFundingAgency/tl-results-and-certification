...
{
    public class When_Is_Active_And_Has_Results_PostResult_Returns_Expected : TestSetup
    {
        public override void Given()
            => Given(SearchRegistrationType.PostResult, isWithdrawn: false, hasResults: true);
        ...
        public void Then_Returns_Expected()
        {
            ...
            Result.RegistrationDetails[0].Route.RouteName.Should().Be(RouteConstants.PrsLearnerDetails);
        }
    }
}