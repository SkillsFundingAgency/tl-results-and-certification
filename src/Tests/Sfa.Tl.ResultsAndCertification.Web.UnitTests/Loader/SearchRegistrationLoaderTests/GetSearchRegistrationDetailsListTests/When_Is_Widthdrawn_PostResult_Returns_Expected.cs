...
{
    public class When_Is_Widthdrawn_PostResult_Returns_Expected : TestSetup
    {
        public override void Given()
            => Given(SearchRegistrationType.PostResult, isWithdrawn: true, hasResults: true);
        ...
        public void Then_Returns_Expected()
        {
            ...
            Result.RegistrationDetails[0].Route.RouteName.Should().Be(RouteConstants.PrsUlnWithdrawn);
        }
    }
}