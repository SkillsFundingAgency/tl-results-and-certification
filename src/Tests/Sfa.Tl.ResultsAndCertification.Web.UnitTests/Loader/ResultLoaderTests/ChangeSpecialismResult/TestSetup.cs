...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.ResultLoaderTests.ChangeSpecialismResult
{
    public abstract class TestSetup : BaseTest<ResultLoader>
    {
        ...
        protected readonly ComponentType componentType = ComponentType.Specialism;
            ...
            var mapperConfig = new MapperConfiguration(c =>
            {
                ...
                c.ConstructServicesUsing(type =>
                            type.Name.Contains("UserNameResolver") ?
                                new UserNameResolver<ManageSpecialismResultViewModel, ChangeResultRequest>(HttpContextAccessor) : null);
            });
        ...
        {
            ActualResult = await Loader.ChangeSpecialismResultAsync(AoUkprn, ViewModel);
        }
    }
}
