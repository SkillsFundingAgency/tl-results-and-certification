...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.ResultLoaderTests.GetResultNoAssessmentEntryViewModel
{
    public abstract class TestSetup : BaseTest<ResultLoader>
    {
        ...
        protected ResultDetailsViewModel ResultDetailsViewModel;
        protected ResultNoAssessmentEntryViewModel ActualResult;
        ...
        {
            ActualResult = Loader.GetResultNoAssessmentEntryViewModel(ResultDetailsViewModel);
