...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.ResultLoaderTests.ProcessBulkResults
{
    public class When_Mapper_Called_With_No_Stats : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            uploadResultsResponseMapperResult.BlobUniqueReference.Should().Be(BulkResultResponse.BlobUniqueReference);
            uploadResultsResponseMapperResult.ErrorFileSize.Should().Be(BulkResultResponse.ErrorFileSize);
        }
