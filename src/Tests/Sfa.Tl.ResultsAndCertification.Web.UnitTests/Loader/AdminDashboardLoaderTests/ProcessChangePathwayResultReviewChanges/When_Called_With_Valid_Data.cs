...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.AdminDashboardLoaderTests.ProcessChangePathwayResultReviewChanges
{
    ...
    {
        private readonly AdminChangePathwayResultReviewChangesViewModel _model = new()
        {
        ...
        {
            ApiClient.ProcessAdminChangePathwayResultAsync(Arg.Any<ChangePathwayResultRequest>()).Returns(true);
        }

        public async override Task When()
        {
            _result = await Loader.ProcessChangePathwayResultReviewChangesAsync(_model);
        }
