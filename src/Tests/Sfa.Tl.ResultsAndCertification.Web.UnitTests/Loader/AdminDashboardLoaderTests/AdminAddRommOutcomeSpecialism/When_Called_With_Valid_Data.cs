...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.AdminDashboardLoaderTests.AdminAddRommOutcomeSpecialism
{
    public class When_Called_With_Valid_Data : AdminDashboardLoaderTestsBase
    {
        ...
        private AdminAddRommOutcomeSpecialismViewModel _result;
        ...
        {
            _result = await Loader.GetAdminAddRommOutcomeSpecialismAsync(RegistrationPathwayId, SpecialismAssessmentId);
        }
