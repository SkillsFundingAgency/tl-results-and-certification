...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.StatementOfAchievementLoaderTests.CreateSoaPrintingRequest
{
    public class When_Called_With_Valid_Data : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            _expectedApiResult = new SoaPrintingResponse { Uln = SoaLearnerRecordDetailsViewModel.Uln, LearnerName = SoaLearnerRecordDetailsViewModel.LearnerName, IsSuccess = true };
