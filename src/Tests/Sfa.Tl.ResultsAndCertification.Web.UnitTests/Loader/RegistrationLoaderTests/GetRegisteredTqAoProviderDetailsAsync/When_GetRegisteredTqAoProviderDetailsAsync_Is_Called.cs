...
{
    public abstract class When_GetRegisteredTqAoProviderDetailsAsync_Is_Called : BaseTest<RegistrationLoader>
    {
        ...
        {
            ActualResult = Loader.GetRegisteredTqAoProviderDetailsAsync(Ukprn).Result;
        }
    }
}
