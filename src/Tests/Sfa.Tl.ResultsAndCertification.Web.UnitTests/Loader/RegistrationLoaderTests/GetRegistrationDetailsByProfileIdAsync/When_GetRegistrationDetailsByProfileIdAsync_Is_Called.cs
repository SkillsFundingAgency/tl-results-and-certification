...
{
    public abstract class When_GetRegistrationDetailsByProfileIdAsync_Is_Called : BaseTest<RegistrationLoader>
    {
        ...
        protected RegistrationDetails expectedApiResult;
        protected RegistrationDetailsViewModel ActualResult;
        ...
        {
            ActualResult = Loader.GetRegistrationDetailsByProfileIdAsync(AoUkprn, ProfileId).Result;
        }
    }
}
