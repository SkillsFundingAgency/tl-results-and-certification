...
{
    public class When_Learner_Result_QPending : TestSetup
    {
        private AdminLearnerRecord _apiResult;

        public override void Given()
        {
            _apiResult = CreateAdminLearnerRecordWithSpecialismAssessment(RegistrationPathwayId, SpecialismAssessmentId, RegistrationPathwayStatus.Active, "Q - pending result", Constants.SpecialismComponentGradeQpendingResultCode);
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            Result.ErrorMessage.Should().Be(AdminOpenSpecialismRomm.Validation_Result_Pending);
        }
    }
}