...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.AdminPostResultsLoaderTests.GetAdminOpenSpecialismRomm
{
    public class When_Learner_Widthdrawn : TestSetup
    {
        ...
        {
            _apiResult = CreateAdminLearnerRecordWithSpecialismAssessment(RegistrationPathwayId, SpecialismAssessmentId, RegistrationPathwayStatus.Withdrawn, "Pass", "SCG3");
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            Result.ErrorMessage.Should().Be(AdminOpenSpecialismRomm.Validation_Widthdrawn);
        }
    }
}