...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.AdminPostResultsLoaderTests.GetAdminOpenPathwayRomm
{
    public class When_Learner_Result_QPending : TestSetup
    {
        ...
        {
            _apiResult = CreateAdminLearnerRecordWithPathwayAssessment(RegistrationPathwayId, PathwayAssessmentId, RegistrationPathwayStatus.Active, "Q - pending result", Constants.PathwayComponentGradeQpendingResultCode);
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            Result.ErrorMessage.Should().Be(AdminOpenPathwayRomm.Validation_Result_Pending);
        }
    }
}