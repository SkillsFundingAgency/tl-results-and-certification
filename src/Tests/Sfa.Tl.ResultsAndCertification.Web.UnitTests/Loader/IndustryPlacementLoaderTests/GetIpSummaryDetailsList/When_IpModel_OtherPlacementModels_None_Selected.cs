...
{
    public class When_IpModel_OtherPlacementModels_None_Selected : TestSetup
    {
            ...
            CacheModel = new IndustryPlacementViewModel
            {
                ...
                IpModelViewModel = new IpModelViewModel
                {
                    ...
                    IpMultiEmployerOther = new IpMultiEmployerOtherViewModel
                    {
                        ...
                        {
                            new IpLookupDataViewModel { Name = "IpModel 1", IsSelected = false },
                ...
                {
                    IpTempFlexibilityUsed = new IpTempFlexibilityUsedViewModel { IsTempFlexibilityUsed = false }
                }
            };
