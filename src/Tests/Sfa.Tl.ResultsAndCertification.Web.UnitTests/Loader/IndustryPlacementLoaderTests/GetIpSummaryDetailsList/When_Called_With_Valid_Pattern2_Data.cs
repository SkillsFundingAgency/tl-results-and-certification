    ...
    public class When_Called_With_Valid_Pattern2_Data : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            _expectedSummaryDetails = new List<SummaryItemModel>
            {
                ...
                new SummaryItemModel { Id = "tempflexusedlist", Title = CheckAndSubmitContent.Title_TempFlex_Emp_Led_Text, Value = "<p>TF1</p><p>TF2</p>", ActionText = CheckAndSubmitContent.Link_Change, IsRawHtml = true }
            };
        }
