    ...
    public class When_Called_With_Valid_Pattern1_Data : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            _expectedSummaryDetails = new List<SummaryItemModel>
            {
                ...
                new SummaryItemModel { Id = "anyothertempflexlist", Title = CheckAndSubmitContent.Title_TempFlex_Emp_Led_Text, Value = "Yes", ActionText = CheckAndSubmitContent.Link_Change, IsRawHtml = true, HiddenActionText = CheckAndSubmitContent.Hidden_Text_Tf_Employer_Led_List }
            };
        }
