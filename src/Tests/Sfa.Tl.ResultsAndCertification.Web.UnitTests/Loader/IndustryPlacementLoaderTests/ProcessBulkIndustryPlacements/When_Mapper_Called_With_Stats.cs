...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.IndustryPlacementLoaderTests.ProcessBulkIndustryPlacements
{
    public class When_Mapper_Called_With_Stats : TestSetup
    {
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            uploadIndustryPlacementsResponseMapperResult.Stats.Should().NotBeNull();
            uploadIndustryPlacementsResponseMapperResult.Stats.TotalRecordsCount.Should().Be(BulkIndustryPlacementResponse.Stats.TotalRecordsCount);
        }
