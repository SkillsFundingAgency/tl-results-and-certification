...
{
    public class When_Called_With_IpCompletionViewModel : TestSetup
    {
        private Models.Contracts.TrainingProvider.LearnerRecordDetails _expectedApiResult;
        protected IpCompletionViewModel ActualResult { get; set; }
        ...
        {
            ActualResult = await Loader.GetLearnerRecordDetailsAsync<IpCompletionViewModel>(ProviderUkprn, ProfileId);
        }
