...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.TrainingProviderTests.ProcessIndustryPlacementQuestionUpdate
{
    public class When_Success : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            ViewModel = new UpdateIndustryPlacementQuestionViewModel { ProfileId = 1, RegistrationPathwayId = 1, IndustryPlacementId = 10, IndustryPlacementStatus = IndustryPlacementStatus.NotCompleted };
