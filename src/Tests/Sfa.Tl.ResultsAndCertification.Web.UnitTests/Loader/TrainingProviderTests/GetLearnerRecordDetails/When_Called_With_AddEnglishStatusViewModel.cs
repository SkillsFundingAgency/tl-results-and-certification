...
{
    public class When_Called_With_AddEnglishStatusViewModel : TestSetup
    {
        private Models.Contracts.TrainingProvider.LearnerRecordDetails _expectedApiResult;
        protected AddEnglishStatusViewModel ActualResult { get; set; }
        ...
        {
            ActualResult = await Loader.GetLearnerRecordDetailsAsync<AddEnglishStatusViewModel>(ProviderUkprn, ProfileId);
        }
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            ActualResult.SubjectStatus.Should().Be(_expectedApiResult.EnglishStatus);
