...
{
    public abstract class When_IsAnyProviderSetupCompletedasync_Is_Called : BaseTest<ProviderLoader>
    {
        ...
        {
            ActualResult = Loader.IsAnyProviderSetupCompletedAsync(Ukprn).Result;
        }
    }
}
