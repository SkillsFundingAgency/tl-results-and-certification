...
{
    public class When_Called_With_PrsAppealCheckAndSubmitViewModel_For_Specialism : TestSetup
    {
        ...
        {
            ActualResult = await Loader.GetPrsLearnerDetailsAsync<PrsAppealCheckAndSubmitViewModel>(AoUkprn, ProfileId, AssessmentId, ComponentType.Specialism);
        }
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            ActualResult.OldGrade.Should().Be(expectedAssessment.Result.Grade);
