...
{
    public class When_Called_With_PrsAppealGradeChangeViewModel_For_Specialism : TestSetup
    {
        ...
        {
            ActualResult = await Loader.GetPrsLearnerDetailsAsync<PrsAppealGradeChangeViewModel>(AoUkprn, ProfileId, AssessmentId, ComponentType.Specialism);
        }
