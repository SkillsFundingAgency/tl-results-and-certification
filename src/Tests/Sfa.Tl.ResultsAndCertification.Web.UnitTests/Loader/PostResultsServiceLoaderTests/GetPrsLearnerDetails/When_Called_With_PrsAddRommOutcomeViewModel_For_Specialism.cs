...
{
    public class When_Called_With_PrsAddRommOutcomeViewModel_For_Specialism : TestSetup
    {
        ...
        {
            ActualResult = await Loader.GetPrsLearnerDetailsAsync<PrsAddRommOutcomeViewModel>(AoUkprn, ProfileId, AssessmentId, ComponentType.Specialism);
        }
