...
{
    public class When_Called_With_PrsAddAppealOutcomeKnownViewModel_For_Specialism : TestSetup
    {
        ...
        {
            ActualResult = await Loader.GetPrsLearnerDetailsAsync<PrsAddAppealOutcomeKnownViewModel>(AoUkprn, ProfileId, AssessmentId, ComponentType.Specialism);
        }
        ...
        public void Then_Returns_Expected_Results()
        {
            ...
            ActualResult.AppealEndDate.Should().Be(expectedAssessment.AppealEndDate);
