...
{
    public class When_Called_With_PrsAddAppealOutcomeViewModel_For_Core : TestSetup
    {
        ...
        {
            ActualResult = await Loader.GetPrsLearnerDetailsAsync<PrsAddAppealOutcomeViewModel>(AoUkprn, ProfileId, AssessmentId, ComponentType.Core);
        }
