...
{
    public class When_Called_With_PrsRommCheckAndSubmitViewModel_For_Specialism : TestSetup
    {
        ...
        {
            ActualResult = await Loader.GetPrsLearnerDetailsAsync<PrsRommCheckAndSubmitViewModel>(AoUkprn, ProfileId, AssessmentId, ComponentType.Specialism);
        }
