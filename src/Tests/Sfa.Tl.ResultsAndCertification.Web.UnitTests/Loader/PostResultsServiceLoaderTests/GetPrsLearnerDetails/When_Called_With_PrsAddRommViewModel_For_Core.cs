...
{
    public class When_Called_With_PrsAddRommViewModel_For_Core : TestSetup
    {
        ...
        {
            ActualResult = await Loader.GetPrsLearnerDetailsAsync<PrsAddRommViewModel>(AoUkprn, ProfileId, AssessmentId, ComponentType.Core);
        }
