...
{
    public class When_Called_With_PrsAddAppealOutcomeViewModel_For_Specialism : TestSetup
    {
        private LearnerRecord _expectedApiResult;
        protected PrsAddAppealOutcomeViewModel ActualResult { get; set; }
        ...
        {
            ActualResult = await Loader.GetPrsLearnerDetailsAsync<PrsAddAppealOutcomeViewModel>(AoUkprn, ProfileId, AssessmentId, ComponentType.Specialism);
        }
