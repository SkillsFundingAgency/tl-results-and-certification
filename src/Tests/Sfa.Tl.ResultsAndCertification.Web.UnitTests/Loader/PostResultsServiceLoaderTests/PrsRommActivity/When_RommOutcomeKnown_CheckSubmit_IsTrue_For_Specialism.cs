...
{
    public class When_RommOutcomeKnown_CheckSubmit_IsTrue_For_Specialism : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            InternalApiClient.GetLookupDataAsync(LookupCategory.SpecialismComponentGrade).Returns(lookupGrades);
