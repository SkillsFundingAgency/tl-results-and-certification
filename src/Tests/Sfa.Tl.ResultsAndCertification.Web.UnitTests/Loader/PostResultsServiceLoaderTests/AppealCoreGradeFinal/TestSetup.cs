...
namespace Sfa.Tl.ResultsAndCertification.Web.UnitTests.Loader.PostResultsServiceLoaderTests.AppealCoreGradeFinal
{
    public abstract class TestSetup :  BaseTest<PostResultsServiceLoader>
    {
        ...
        protected PrsPathwayGradeCheckAndSubmitViewModel ViewModel;
            ...
            var mapperConfig = new MapperConfiguration(c =>
            {
                ...
                c.ConstructServicesUsing(type =>
                            type.Name.Contains("UserNameResolver") ?
                                new UserNameResolver<PrsPathwayGradeCheckAndSubmitViewModel, PrsActivityRequest>(HttpContextAccessor) : null);
            });
        ...
        {
            ActualResult = await Loader.AppealCoreGradeAsync(AoUkprn, ViewModel);
        }
    }
}