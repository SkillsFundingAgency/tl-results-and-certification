...
{
    public class When_Called_With_PrsUlnWithdrawnViewModel : TestSetup
    {
        public PrsUlnWithdrawnViewModel ActualResult;
        ...
        {
            ActualResult = Loader.TransformLearnerDetailsTo<PrsUlnWithdrawnViewModel>(FindPrsLearnerRecord);
