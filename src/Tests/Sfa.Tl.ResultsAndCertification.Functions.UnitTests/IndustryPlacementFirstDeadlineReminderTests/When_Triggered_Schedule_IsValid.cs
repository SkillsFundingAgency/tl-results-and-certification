...
namespace Sfa.Tl.ResultsAndCertification.Functions.UnitTests.IndustryPlacementFirstDeadlineReminderTests
{
    public class When_Triggered_Schedule_IsValid : TestSetup
    {
        public override void Given()
        {
            ...
            IndustryPlacementNotificationService.ProcessIndustryPlacementFirstDeadlineReminderAsync().Returns(new IndustryPlacementNotificationResponse { IsSuccess = true });
