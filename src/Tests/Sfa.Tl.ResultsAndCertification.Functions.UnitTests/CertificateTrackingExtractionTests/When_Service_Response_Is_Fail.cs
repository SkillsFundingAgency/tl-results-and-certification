...
{
    public class When_Service_Response_Is_Fail : TestSetup
    {
        public override void Given()
        {
            CommonService.CreateFunctionLog(Arg.Any<FunctionLogDetails>()).Returns(true);
            Service.ProcessCertificateTrackingExtractAsync(Arg.Any<Func<DateTime>>(), Arg.Any<Func<string>>()).Returns(new FunctionResponse { IsSuccess = false, Message = "Error message." });
