...
namespace Sfa.Tl.ResultsAndCertification.Functions.UnitTests.IndustryPlacementMissedDeadlineReminderTests
{
    public class When_Response_Is_Failed : TestSetup
    {
        public override void Given()
        {
            ...
            IndustryPlacementNotificationService.ProcessIndustryPlacementMissedDeadlineReminderAsync().Returns(new IndustryPlacementNotificationResponse { IsSuccess = false });
