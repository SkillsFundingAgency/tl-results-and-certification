...
namespace Sfa.Tl.ResultsAndCertification.Functions.UnitTests.IndustryPlacementChaseBigGapsReminderTests
{
    public class When_Triggered_Schedule_IsValid : TestSetup
    {
        public override void Given()
        {
            ...
            IndustryPlacementNotificationService.ProcessIndustryPlacementChaseBigGapsReminderAsync().Returns(new IndustryPlacementNotificationResponse { IsSuccess = true });
