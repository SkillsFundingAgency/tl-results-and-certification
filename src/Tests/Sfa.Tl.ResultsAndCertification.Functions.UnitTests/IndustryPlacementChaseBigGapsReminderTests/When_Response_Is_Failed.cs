...
namespace Sfa.Tl.ResultsAndCertification.Functions.UnitTests.IndustryPlacementChaseBigGapsReminderTests
{
    public class When_Response_Is_Failed : TestSetup
    {
        public override void Given()
        {
            ...
            IndustryPlacementNotificationService.ProcessIndustryPlacementChaseBigGapsReminderAsync().Returns(new IndustryPlacementNotificationResponse { IsSuccess = false });
        ...
        public void Then_Expected_Methods_Are_Called()
        {
            ...
            IndustryPlacementNotificationService.Received(1).ProcessIndustryPlacementChaseBigGapsReminderAsync();
