...
{
    public class When_Called_ProcessCertificatesForPrinting_With_No_Data : TestSetup
    {
        ...
        public override void Given()
        {
            ...
            List<CertificateResponse> apiResponse = null;
            CertificateService.ProcessCertificatesForPrintingAsync().Returns(apiResponse);
        }
