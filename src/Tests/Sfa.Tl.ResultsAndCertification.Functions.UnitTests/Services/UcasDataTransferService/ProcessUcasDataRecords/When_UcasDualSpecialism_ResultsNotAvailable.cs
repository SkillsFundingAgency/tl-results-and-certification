...
{
    public class When_UcasDualSpecialism_ResultsNotAvailable : TestBase
    {
        ...
        public void Then_Expected_DualSpecialsim_Result_Matches()
        {
            ...
            Assert.Empty(_dataComponent.FirstOrDefault().Grade);
        }
        ...
        private TqRegistrationPathway GetExpectedPathwayMockData()
        {
            ...
            "\"PathwayResult\": \"A*\",    \"SpecialismDetails\": [{ \"SpecialismName\": \"Heating Engineering\",\"SpecialismLarId\": \"10202101\",\"SpecialismResult\": \"\"}, " +
