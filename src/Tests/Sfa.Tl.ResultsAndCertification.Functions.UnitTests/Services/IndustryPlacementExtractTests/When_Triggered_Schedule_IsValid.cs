...
namespace Sfa.Tl.ResultsAndCertification.Functions.UnitTests.IndustryPlacementExtractTests
{
    public class When_Triggered_Schedule_IsValid : TestSetup
    {
        public override void Given()
        {
            ...
            IndustryPlacementService.ProcessIndustryPlacementExtractionsAsync().Returns(new FunctionResponse { IsSuccess = true });
        ...
        public void Then_Expected_Methods_Are_Called()
        {
            ...
            IndustryPlacementService.Received(1).ProcessIndustryPlacementExtractionsAsync();
