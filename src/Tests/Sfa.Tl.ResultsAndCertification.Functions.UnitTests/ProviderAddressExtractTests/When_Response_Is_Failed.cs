...
namespace Sfa.Tl.ResultsAndCertification.Functions.UnitTests.ProviderAddressExtractTests
{
    public class When_Response_Is_Failed : TestSetup
    {
        public override void Given()
        {
            ...
            ProviderAddressExtractionService.ProcessProviderAddressExtractionAsync(AcademicYearsToProcess).Returns(new FunctionResponse { IsSuccess = false, Message = "Error message." });
