...
namespace Sfa.Tl.ResultsAndCertification.Functions.UnitTests.OverallResultCalculation
{
    public class When_Response_Is_PartiallyProcessed : TestSetup
    {
        public override void Given()
        {
            ...
            OverallResultCalculationFunctionService.CalculateOverallResultsAsync().Returns(new List<OverallResultResponse> { new OverallResultResponse { IsSuccess = true }, new OverallResultResponse { IsSuccess = false } });
