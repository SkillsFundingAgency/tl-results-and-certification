...
namespace Sfa.Tl.ResultsAndCertification.Functions.UnitTests.IndustryPlacementOneOutstandingUlnReminderTests
{
    public class When_Triggered_Schedule_IsValid : TestSetup
    {
        public override void Given()
        {
            ...
            IndustryPlacementNotificationService.ProcessIndustryPlacementOneOutstandingUlnReminderAsync().Returns(new IndustryPlacementNotificationResponse { IsSuccess = true });
