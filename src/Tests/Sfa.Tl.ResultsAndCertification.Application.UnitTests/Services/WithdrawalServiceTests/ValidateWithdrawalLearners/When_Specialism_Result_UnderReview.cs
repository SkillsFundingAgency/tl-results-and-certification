...
{
    public class When_Specialism_Result_UnderReview : WithdrawalServiceBaseTest
    {
        ...
        {
            TqRegistrationProfile profile = CreateTqRegistrationProfile(TqRegistrationProfileId, Uln, _dob, specialismResultStatus: PrsStatus.UnderReview);
