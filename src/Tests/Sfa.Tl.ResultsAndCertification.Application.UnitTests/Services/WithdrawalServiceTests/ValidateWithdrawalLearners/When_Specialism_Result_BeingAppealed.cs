...
{
    public class When_Specialism_Result_BeingAppealed : WithdrawalServiceBaseTest
    {
        ...
        {
            TqRegistrationProfile profile = CreateTqRegistrationProfile(TqRegistrationProfileId, Uln, _dob, specialismResultStatus: PrsStatus.BeingAppealed);
