...
{
    public class When_Core_Result_BeingAppealed : WithdrawalServiceBaseTest
    {
        ...
        {
            TqRegistrationProfile profile = CreateTqRegistrationProfile(TqRegistrationProfileId, Uln, _dob, pathwayResultStatus: PrsStatus.BeingAppealed);
