...
{
    public class When_Inactive_ULN : WithdrawalServiceBaseTest
    {
        ...
        {
            TqRegistrationProfile profile = CreateTqRegistrationProfile(TqRegistrationProfileId, Uln, new DateTime(2020, 1, 2), RegistrationPathwayStatus.Withdrawn);
        ...
        public void Then_Returns_Expected_Results()
            => Then_Returns_Expected_ValidationErrors_Results(_actualResult, rowNum: 2, Uln, ValidationMessages.InactiveUln);
    }
}