...
{
    public class ProcessIndustryPlacementChaseBigGapsReminder : IndustryPlacementNotificationServiceBaseTest
    {
        ...
        {
            Result = await IndustryPlacementNotificationService.ProcessIndustryPlacementChaseBigGapsReminderAsync();
        }
