...
{
    public class When_GetDataExportCoreAssessments_IsCalled : DataExportRepositoryBaseTest
    {
        ...
        public async Task WhenAsync(long aoUkprn)
        {
            ...
            _actualResult = await DataExportRepository.GetDataExportCoreAssessmentsAsync(aoUkprn);
        }
