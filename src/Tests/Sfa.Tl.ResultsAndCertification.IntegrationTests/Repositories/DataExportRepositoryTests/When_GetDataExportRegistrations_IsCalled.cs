...
{
    public class When_GetDataExportRegistrations_IsCalled : DataExportRepositoryBaseTest
    {
        ...
        public async Task WhenAsync(long aoUkprn)
        {
            ...
            _actualResult = await DataExportRepository.GetDataExportRegistrationsAsync(aoUkprn);
        }
