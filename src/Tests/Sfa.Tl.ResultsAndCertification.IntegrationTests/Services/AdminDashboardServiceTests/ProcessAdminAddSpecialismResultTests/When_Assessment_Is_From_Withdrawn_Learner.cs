...
{
    public class When_Assessment_Is_From_Withdrawn_Learner : ProcessAdminAddSpecialismResultTestsBase
    {
        ...
        {
            int specialismAssessmentId = CreateAndSaveSpecialismAssessment(RegistrationSpecialismId, new DateTime(2024, 1, 1));
