...
{
    public class When_IndustryPlacement_Doesnt_Exist_And_SpecialConsiderations : ProcessChangeIndustryPlacementTestsBase
    {
        ...
        {
            _request = CreateRequest(RegistrationPathwayId, IndustryPlacementStatus.CompletedWithSpecialConsideration, 150, 1, 2, 3);
