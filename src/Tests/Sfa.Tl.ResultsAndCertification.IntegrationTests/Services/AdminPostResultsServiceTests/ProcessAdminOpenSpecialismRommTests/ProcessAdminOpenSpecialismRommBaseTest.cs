...
{
    public abstract class ProcessAdminOpenSpecialismRommBaseTest : AdminPostResultsServiceBaseTest
    {
        protected static OpenSpecialismRommRequest CreateRequest(int registrationPathwayId, int specialismResultId)
        {
            return new()
            {
        ...
        private static TqSpecialismResult CreateSpecialismResult(int specialismAssessmentId, int tlLookupId)
            => new()
            {
