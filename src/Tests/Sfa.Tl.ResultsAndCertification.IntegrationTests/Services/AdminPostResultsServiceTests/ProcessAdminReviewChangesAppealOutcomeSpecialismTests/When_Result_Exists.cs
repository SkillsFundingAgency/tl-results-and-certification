...
namespace Sfa.Tl.ResultsAndCertification.IntegrationTests.Services.AdminPostResultsServiceTests.ProcessAdminReviewChangesAppealOutcommSpecialismTests
{
    public class When_Result_Exists : ProcessAdminReviewChangesAppealOutcomeSpecialismBaseTest
    {
        ...
        private ReviewChangesAppealOutcomeSpecialismRequest _request;
        ...
        {
            _result = await _service.ProcessAdminReviewChangesAppealOutcomeSpecialismAsync(_request);
        }
        ...
        public async void Then_Should_Return_False()
        {
            ...
            changeLog.ChangeType.Should().Be(ChangeType.SpecialismAppealOutcome);
