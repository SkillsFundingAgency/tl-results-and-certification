...
namespace Sfa.Tl.ResultsAndCertification.IntegrationTests.Services.AdminPostResultsServiceTests.ProcessAdminReviewChangesAppealOutcommSpecialismTests
{
    public abstract class ProcessAdminReviewChangesAppealOutcomeSpecialismBaseTest : AdminPostResultsServiceBaseTest
    {
        protected static ReviewChangesAppealOutcomeSpecialismRequest CreateRequest(int registrationPathwayId, int specialismResultId)
        {
            return new()
            {
