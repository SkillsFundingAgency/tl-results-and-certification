...
{
    public class When_Result_Exists : ProcessAdminOpenPathwayRommBaseTest
    {
        ...
        private OpenPathwayRommRequest _request;
        ...
        {
            _result = await _service.ProcessAdminOpenPathwayRommAsync(_request);
        }
        ...
        public async void Then_Should_Return_False()
        {
            ...
            newPathwayResultDb.TlLookupId.Should().Be(_existingPathwayResult.TlLookupId);
            newPathwayResultDb.PrsStatus.Should().Be(PrsStatus.UnderReview);
