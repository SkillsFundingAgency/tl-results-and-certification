...
namespace Sfa.Tl.ResultsAndCertification.IntegrationTests.Services.AdminPostResultsServiceTests.ProcessAdminReviewChangesAppealOutcommCoreTests
{
    ...
    {
        protected static ReviewChangesAppealOutcomeCoreRequest CreateRequest(int registrationPathwayId, int pathwayResultId)
        {
            return new()
            {
        ...
        public static TqPathwayResult CreatePathwayResult(int pathwayAssessmentId, int tlLookupId)
            => new()
            {
