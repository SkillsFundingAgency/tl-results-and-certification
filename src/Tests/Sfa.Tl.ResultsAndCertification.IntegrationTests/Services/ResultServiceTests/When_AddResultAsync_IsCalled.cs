            ...
            get
            {
                return new[]
                {
                    ...
                    { new AddResultRequest { AoUkprn = 10011881, ProfileId = 3, LookupId = 1, ComponentType = ComponentType.Core },
                      new AddResultResponse { IsSuccess = true, Uln = 1111111113, ProfileId = 3 } }, // LookupId = 1 - A*

                    // valid request - returns true
                    new object[]
                    { new AddResultRequest { AoUkprn = 10011881, ProfileId = 4, LookupId = 8, ComponentType = ComponentType.Core },
                      new AddResultResponse { IsSuccess = true, Uln = 1111111114, ProfileId = 4 } }, // LookupId = 8 - Q - pending result

                    // valid request - returns true
                    new object[]
                    { new AddResultRequest { AoUkprn = 10011881, ProfileId = 5, LookupId = 9, ComponentType = ComponentType.Core },
                      new AddResultResponse { IsSuccess = true, Uln = 1111111115, ProfileId = 5 } } // LookupId = 9 - X - no result
                };
            }
        }
    }
