...
{
    public class When_GetRegistrationDetailsByProfileIdAsync_Is_Called : RegistrationServiceBaseTest
    {
        ...
        public void Then_Expected_Response_Is_Returned(long aoUkprn, int profileId, RegistrationDetails expectedResponse)
        {
