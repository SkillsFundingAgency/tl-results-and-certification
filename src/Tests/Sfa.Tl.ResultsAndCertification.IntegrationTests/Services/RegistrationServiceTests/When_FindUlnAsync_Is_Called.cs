...
{
    public class When_FindUlnAsync_Is_Called : RegistrationServiceBaseTest
    {
        ...
        public void Then_Expected_Response_Is_Returned(long ukprn, long uln, FindUlnResponse expectedResponse)
        {
