...
{
    public class When_GetRegistration_IsCalled : RegistrationServiceBaseTest
    {
        ...
        public void Then_Returns_Expected_Results(long aoUkprn, int profileId, ManageRegistration expectedResponse)
        {
