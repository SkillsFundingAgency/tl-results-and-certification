...
namespace Sfa.Tl.ResultsAndCertification.IntegrationTests.Services.RegistrationServiceTests
{
    ...
    public class When_CompareAndProcessRegistrationsAsync_Is_Called_With_Amended_Registrations : IClassFixture<BulkRegistrationsTextFixture>
    {
        private RegistrationProcessResponse _result;
        private BulkRegistrationsTextFixture _bulkRegistrationTestFixture;

        public When_CompareAndProcessRegistrationsAsync_Is_Called_With_Amended_Registrations(BulkRegistrationsTextFixture bulkRegistrationTestFixture)
        {
