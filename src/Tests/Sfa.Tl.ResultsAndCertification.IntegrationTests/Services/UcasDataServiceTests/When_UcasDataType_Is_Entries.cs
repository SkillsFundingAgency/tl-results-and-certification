    ...
    public class When_UcasDataType_Is_Entries : UcasDataServiceBaseTest
    {
        ...
        public async Task WhenAsync()
        {
            ...
            var expectedDataRecords = new List<ExepectedUcasDataRecord>
            {
                ...
                new ExepectedUcasDataRecord { Uln = 1111111112, Name = "Last 2:First 2", Sex = "F", DateOfBirth = "07051981", ComponentRecord = "_|10123456|||_|TLEVEL|||_|" },
                new ExepectedUcasDataRecord { Uln = 1111111113, Name = "Last 3:First 3", Sex = "F", DateOfBirth = "03071982", ComponentRecord = "_|10123456|||_|TLEVEL|||_|" },
