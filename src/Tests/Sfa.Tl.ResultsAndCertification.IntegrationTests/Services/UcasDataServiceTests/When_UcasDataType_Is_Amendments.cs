...
{
    public class When_UcasDataType_Is_Amendments : UcasDataServiceBaseTest
    {
        ...
        public async Task WhenAsync()
        {
            ...
            ActualResult = await UcasDataService.ProcessUcasDataRecordsAsync(UcasDataType.Amendments);
        }
        ...
        public async Task Then_Expected_Results_Are_Returned()
        {
            ...
            AssertHeaderRecord(UcasDataType.Amendments);
