...
//            };
//            OverallResultCalculationService.GetPreviousAssessmentSeriesAsync(DateTime.Now).Returns(_previousAssessmentSeries);
...
//        {
//            OverallResultCalculationService.GetPreviousAssessmentSeriesAsync(DateTime.Now);
