...
{
    public class When_ProcessIndustryPlacementChaseBigGapsReminder_IsCalled : IndustryPlacementNotificationServiceBaseTest
    {
        ...
        public override void Given()
        {
            ...
            DfeSignInApiClient.GetDfeUsersAllProviders(Arg.Any<List<long>>()).Returns((List<DfeUsers>)
                new List<DfeUsers>
                {
                    {
                        new DfeUsers
                        {
                             Ukprn = TqProvider.TlProvider.UkPrn.ToString(),
        ...
        {
            _actualResult = await IndustryPlacementNotificationService.ProcessIndustryPlacementChaseBigGapsReminderAsync();
        }
