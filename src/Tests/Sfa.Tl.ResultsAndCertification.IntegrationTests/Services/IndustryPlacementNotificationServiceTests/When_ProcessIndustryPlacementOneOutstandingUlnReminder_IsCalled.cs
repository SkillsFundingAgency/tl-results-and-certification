...
{
    public class When_ProcessIndustryPlacementOneOutstandingUlnReminder_IsCalled : IndustryPlacementNotificationServiceBaseTest
    {
        ...
        {
            _actualResult = await IndustryPlacementNotificationService.ProcessIndustryPlacementOneOutstandingUlnReminderAsync();
        }
