...
{
    public class When_ProcessIndustryPlacementFirstDeadlineReminder_IsCalled : IndustryPlacementNotificationServiceBaseTest
    {
        ...
        {
            _actualResult = await IndustryPlacementNotificationService.ProcessIndustryPlacementFirstDeadlineReminderAsync();
        }
