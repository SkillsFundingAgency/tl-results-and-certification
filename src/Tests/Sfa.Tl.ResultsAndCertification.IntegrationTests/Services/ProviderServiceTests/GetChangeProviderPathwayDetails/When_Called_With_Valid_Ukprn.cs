...
namespace Sfa.Tl.ResultsAndCertification.IntegrationTests.Services.ProviderServiceTests.GetChangeProviderPathwayDetails
{
    public class When_Called_With_Valid_Ukprn : ProviderServiceBaseTest
    {
        ...
        {
            _result = await ProviderService.GetChangeProviderPathwayDetailsAsync(TlAwardingOrganisation.UkPrn, TlProvider.UkPrn);
        }
