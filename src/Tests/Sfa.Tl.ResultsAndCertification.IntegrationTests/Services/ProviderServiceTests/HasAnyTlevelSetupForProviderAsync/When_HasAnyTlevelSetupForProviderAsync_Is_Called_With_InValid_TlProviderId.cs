...
{
    public class When_HasAnyTlevelSetupForProviderAsync_Is_Called_With_InValid_TlProviderId : ProviderServiceBaseTest
    {
        ...
        {
            _result = ProviderService.HasAnyTlevelSetupForProviderAsync(TlAwardingOrganisation.UkPrn, 123).Result; // passing invalid TlProviderId
        }
