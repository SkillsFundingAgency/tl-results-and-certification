...
{
    public class When_Registrations_Upload_File_Has_Validation_Errors : RegistrationsCsvHelperServiceBaseTest
    {
        ...
        [Fact]
        public void Then_Expected_Validation_Errors_Are_Returned()
        {
