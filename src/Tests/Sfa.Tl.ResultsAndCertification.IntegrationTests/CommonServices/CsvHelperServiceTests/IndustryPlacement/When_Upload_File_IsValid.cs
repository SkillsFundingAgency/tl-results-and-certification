...
{
    public class When_Upload_File_IsValid : IndustryPlacementStatusCsvHelperServiceBaseTest
    {
        private const string _dataFilePath = @"CommonServices\CsvHelperServiceTests\IndustryPlacement\TestData\IndustryPlacement_Stage2_Valid_File.csv";
