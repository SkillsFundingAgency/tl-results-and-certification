...
{
    public class When_Upload_File_Header_Validation : IndustryPlacementStatusCsvHelperServiceBaseTest
    {
        private const string _dataFilePath = @"CommonServices\CsvHelperServiceTests\IndustryPlacement\TestData\IndustryPlacement_Stage2_Header_Validation.csv";
