...
namespace Sfa.Tl.ResultsAndCertification.Web.Loader.Interfaces
{
    public interface IAdminDashboardLoader
    {
        ...
        Task<bool> RemoveAssessmentEntry(AdminReviewRemoveCoreAssessmentEntryViewModel model);

        Task<bool> RemoveSpecialismAssessmentEntryAsync(AdminReviewRemoveSpecialismAssessmentEntryViewModel model);
    }
}