    ...
    public class AssessmentMapper : Profile
    {
        public AssessmentMapper()
        {
            ...
            CreateMap<AssessmentDetails, AssessmentDetailsViewModel>()
                ...
                .ForMember(d => d.AvailableAssessmentSeries, opts => opts.MapFrom(s => s.AvailableAssessmentSeries))
                .ForMember(d => d.PathwayAssessmentSeries, opts => opts.MapFrom(s => s.AvailableAssessmentSeries != null ? s.PathwayAssessmentSeries : null))
