...
namespace Sfa.Tl.ResultsAndCertification.Web.Mapper
{
    ...
    {
        private const string ReplaceNullWithNA= "N/A";
        ...
        public AdminAssessmentSeriesDatesMapper()
        {
            CreateMap<GetAssessmentSeriesDatesDetailsResponse, AdminAssessmentSeriesDetailsViewModel>()
              ...
              .ForMember(d => d.SummaryResultPublishDate, opts => opts.MapFrom(s => CreateSummary("resultspublishdate", AdminAssessmentSeriesDateDetails.Label_Result_Publish_Date, s.ResultPublishDate.HasValue ? s.ResultPublishDate.ToString() : ReplaceNullWithNA)))
              .ForMember(d => d.SummaryPrintAvailableDate, opts => opts.MapFrom(s => CreateSummary("printavailabledate", AdminAssessmentSeriesDateDetails.Label_Print_Available_Date, s.PrintAvailableDate.HasValue ? s.PrintAvailableDate.ToString() : ReplaceNullWithNA)));
