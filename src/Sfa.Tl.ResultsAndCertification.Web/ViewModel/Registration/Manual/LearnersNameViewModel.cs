...
namespace Sfa.Tl.ResultsAndCertification.Web.ViewModel.Registration.Manual
{
    public class LearnersNameViewModel
    {
        ...
        [RegularExpression(@"^[\p{L}\p{M}' \-]+$", ErrorMessageResourceType = typeof(ErrorResource.LearnersName), ErrorMessageResourceName = "Validation_Lastname_Cannot_Contain_Integers_Or_Special_Characters")]
