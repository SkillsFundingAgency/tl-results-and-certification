...
namespace Sfa.Tl.ResultsAndCertification.Web.ViewModel.Registration.Manual
{
    public class RegistrationDetailsViewModel
    {
        ...
        public SummaryItemModel SummaryAcademicYear => new SummaryItemModel { Id = "academicyear", Title = RegistrationDetailsContent.Title_AcademicYear_Text, Value = EnumExtensions.GetDisplayName<AcademicYearDelete>(AcademicYear), ActionText = ActionText, RouteName = RouteConstants.ChangeAcademicYear, RouteAttributes = ChangeLinkRouteAttributes };
