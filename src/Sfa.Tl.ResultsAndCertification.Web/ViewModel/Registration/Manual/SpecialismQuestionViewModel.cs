...
namespace Sfa.Tl.ResultsAndCertification.Web.ViewModel.Registration.Manual
{
    public class SpecialismQuestionViewModel
    {
        ...
        public virtual BackLinkModel BackLink => new BackLinkModel { RouteName = (IsChangeMode && !IsChangeModeFromCore) ? RouteConstants.AddRegistrationCheckAndSubmit : RouteConstants.AddRegistrationCore, RouteAttributes = (IsChangeMode && IsChangeModeFromCore) ? new Dictionary<string, string> { { Constants.IsChangeMode, "true" } } : null };
    }
}
