...
namespace Sfa.Tl.ResultsAndCertification.Web.ViewModel.Result.Manual
{
    public class ComponentExamViewModel
    {
        ...
        public string PrsDisplayText { get { return IsResultChangeAllowed ? string.Empty : CommonHelper.GetPrsStatusDisplayText(PrsStatus, RommEndDate, AppealEndDate); } }
        ...
        public bool IsResultChangeAllowed => (!string.IsNullOrEmpty(GradeCode) && CommonHelper.IsValidGradeForChangeResult(GradeCode, ComponentType)) ||
