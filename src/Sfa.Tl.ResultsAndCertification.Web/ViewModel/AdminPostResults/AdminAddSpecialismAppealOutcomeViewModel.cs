...
{
    public class AdminAddSpecialismAppealOutcomeViewModel
    {
        ...
        [Required(ErrorMessageResourceType = typeof(AdminAddSpecialismAppealOutcome), ErrorMessageResourceName = "Validation_Message")]
        public bool? WhatIsAppealOutcome { get; set; }
