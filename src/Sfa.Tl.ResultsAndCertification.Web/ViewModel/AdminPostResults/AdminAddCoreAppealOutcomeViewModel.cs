...
{
    public class AdminAddCoreAppealOutcomeViewModel
    {
        ...
        [Required(ErrorMessageResourceType = typeof(AdminAddCoreAppealOutcome), ErrorMessageResourceName = "Validation_Message")]
