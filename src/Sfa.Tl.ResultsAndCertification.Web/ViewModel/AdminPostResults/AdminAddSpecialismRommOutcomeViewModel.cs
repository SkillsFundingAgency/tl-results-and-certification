...
{
    public class AdminAddSpecialismRommOutcomeViewModel
    {
        ...
        [Required(ErrorMessageResourceType = typeof(AdminAddSpecialismRommOutcome), ErrorMessageResourceName = "Validation_Message")]
