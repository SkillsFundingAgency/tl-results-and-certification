...
{
    public class AdminViewChangeRecordAddPathwayResultViewModel : AdminViewChangeRecordViewModel
    {
        public AddPathwayResultRequest PathwayResultDetails { get; set; }
        ...
        public AdminReviewSummaryItemModel SummarySelectedGrade => new()
        {
            ...
            Value2 = PathwayResultDetails.GradeTo
        };
