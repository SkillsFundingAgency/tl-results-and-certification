...
{
    public class AdminViewChangeRecordPathwayAppealOutcomeViewModel : AdminViewChangeRecordViewModel
    {
        public string ExamPeriod { get; set; }

        public string Grade { get; set; }

        public PathwayAppealOutcomeDetails AppealOutcomeDetails { get; set; }
