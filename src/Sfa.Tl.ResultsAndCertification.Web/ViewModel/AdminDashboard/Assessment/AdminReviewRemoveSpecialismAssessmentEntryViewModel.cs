...
{
    public class AdminReviewRemoveSpecialismAssessmentEntryViewModel
    {
        public AdminRemoveSpecialismAssessmentEntryViewModel PathwayAssessmentViewModel { get; set; }
        ...
        {
            RouteName = RouteConstants.RemoveAssessmentSpecialismEntry,
            RouteAttributes = new Dictionary<string, string>() { {
                ...
                { Constants.AssessmentId, PathwayAssessmentViewModel.SpecialismAssessmentId.ToString() } }
        };

        public SummaryItemModel SummaryAssessmentYear => new()
        {
            Id = "assessmentyear",
            Title = string.Format(AdminReviewRemoveAssessmentEntry.Label_Occupational_Specialism, PathwayAssessmentViewModel.SpecialismName),
