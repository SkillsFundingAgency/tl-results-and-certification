...
namespace Sfa.Tl.ResultsAndCertification.Web.ViewModel.PostResultsService
{
    public class PrsAddAppealOutcomeViewModel : PrsBaseViewModel
    {
        public PrsAddAppealOutcomeViewModel()
        {
            ...
            SpecialismLabel = PrsAddAppealOutcomeContent.Title_Specialism_Text;
        ...
        public string SuccessBannerMessage => string.Format(PrsAddAppealOutcomeContent.Banner_Message, LearnerName, ExamPeriod, ComponentType == ComponentType.Core ? CoreDisplayName : SpecialismDisplayName);
