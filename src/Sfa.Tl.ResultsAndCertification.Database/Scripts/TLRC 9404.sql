...
BEGIN TRANSACTION [UpdateAcademicYear]
  ...
  BEGIN TRY
	-- Update script for 
	DECLARE @ULN1 BIGINT = 6132081576
...
BEGIN TRANSACTION [UpdateCoreAssessment]
  ...
  BEGIN TRY
  	 ...
  	 -- ULN 6471844505
	 DECLARE @ULN2 BIGINT = 6471844505,
			 @ULN3 BIGINT = 8378805653,
			 @ULN4 BIGINT = 9994253009,
			 @ULN5 BIGINT = 1322580471,
			 @ULN6 BIGINT = 2757754393,
			 @ULN7 BIGINT = 5693362638,
			 @ULN8 BIGINT = 8618567042,
			 @ULN9 BIGINT = 9794483906,
			 @ULN10 BIGINT = 6132081576,
			 @PathwayID INT;
