...
USING (VALUES 
  ...
  AS Source ([Id], [QualificationTypeId], [Grade], [IsAllowable], [IsSendGrade], [IsActive]) 
...
WHEN NOT MATCHED BY TARGET THEN 
	INSERT ([Id], [QualificationTypeId], [Grade], [IsAllowable], [IsSendGrade], [IsActive], [CreatedBy]) 
	VALUES ([Id], [QualificationTypeId], [Grade], [IsAllowable], [IsSendGrade], [IsActive],'System') 
