...
USING (VALUES 
  ...
  (102, 16, N'Pass', 1, 1, 0, 1),
  (103, 16, N'Fail', 2, 0, 0, 1),

  /* Other General Qualification - Level 2 Essential Skills Wales */
  (104, 17, N'Pass', 1, 1, 0, 1),
  (105, 17, N'Fail', 2, 0, 0, 1),

  /* Other Vocational Qualification - British Sign Language */
  (106, 18, N'Pass', 1, 1, 0, 1),
  (107, 18, N'Fail', 2, 0, 0, 1),

  /* Project - British Sign Language */
  (108, 19, N'Pass', 1, 1, 0, 1),
  (109, 19, N'Fail', 2, 0, 0, 1),

  /* QCF - British Sign Language */
  (110, 20, N'Pass', 1, 1, 0, 1),
  (111, 20, N'Fail', 2, 0, 0, 1),
  ...
  (117, 22, N'Pass', 1, 1, 0, 1),
  (118, 22, N'Fail', 2, 0, 0, 1),

  /* Functional Skills - Entry 3 */
  (119, 23, N'Pass', 1, 1, 0, 1),
  (120, 23, N'Fail', 2, 0, 0, 1),

  /* Functional Skills (QCF) - Entry 3 */
  (121, 24, N'Pass', 1, 1, 0, 1),
  (122, 24, N'Fail', 2, 0, 0, 1),

  /* Functional Skills - Level 1 */
  (123, 25, N'Pass', 1, 1, 0, 1),
  (124, 25, N'Fail', 2, 0, 0, 1),

  /* Functional Skills (QCF) - Level 1 */
  (125, 26, N'Pass', 1, 1, 0, 1),
  (126, 26, N'Fail', 2, 0, 0, 1)
  )
