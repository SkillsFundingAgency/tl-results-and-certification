...
USING (VALUES 
  ...
  (2, N'10223456', N'Construction: Onsite Construction', N'Onsite Construction', 1),
  (3, N'10323456', N'Construction: Building Services Engineering', N'Building Services Engineering', 1),
  ...
  (6, N'10623456', N'Digital: Digital Support Services', N'Digital Support Services', 3),
  (7, N'10723456', N'Digital: Digital Business Services', N'Digital Business Services', 3),
  (8, N'10823456', N'Health and Science: Health', N'Health', 4),
  (9, N'10923456', N'Health and Science: Healthcare Science', N'Healthcare Science', 4),
  (10, N'11023456', N'Health and Science: Science', N'Science', 4)
  )
