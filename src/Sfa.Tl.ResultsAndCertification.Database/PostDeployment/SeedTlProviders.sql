...
(22, 10007193, N'HRUC (Harrow, Richmond & Uxbridge Colleges)', N'HRUC (Harrow, Richmond & Uxbridge Colleges)'),
...
(85, 10064840, N'Mulberry UTC', N'Mulberry University Technical College'),
...
(103, 10007455, N'Capital City College Group', N'City and Islington College'),
...
(115, 10000948, N'London South East Colleges', N'Bromley College of Further & Higher Education (LSEC)'),
...
(156, 10007945, N'City of Portsmouth College', N'City of Portsmouth College'),
...
(263, 10031580, N'Leigh Academy Tonbridge', N'Leigh Academy Tonbridge'),
...
(268, 10087521, N'The Hinkley School', N'The Hinkley School'),
...
(438, 10000954, N'Laurel Park School', N'Laurel Park School'),
(439, 10001503, N'The Northern School of Art', N'The Northern School of Art'),
(440, 10001530, N'Codsall Community High School', N'Codsall Community High School'),
(441, 10001754, N'Cressex Community School', N'Cressex Community School'),
(442, 10002639, N'Gateshead Council', N'Gateshead Council'),
(443, 10003128, N'Holy Cross College', N'Holy Cross College'),
(444, 10004050, N'London Nautical School', N'London Nautical School'),
(445, 10004179, N'Manchester Mesivta School', N'Manchester Mesivta School'),
(446, 10005264, N'Millbrook Management Services Limited', N'Prostart Training'),
(447, 10006029, N'Southend City Council', N'Southend City Council'),
(448, 10006130, N'St Brendan''s Sixth Form College', N'St Brendan''s Sixth Form College'),
(449, 10006289, N'St Paul''s Catholic School', N'St Paul''s Catholic School'),
(450, 10007534, N'Winchmore School', N'Winchmore School'),
(451, 10007692, N'Yateley School', N'Yateley School'),
(452, 10009063, N'BUILDING CRAFTS COLLEGE', N'BUILDING CRAFTS COLLEGE'),
(453, 10009664, N'JFS', N'JFS School'),
(454, 10015175, N'Ark Burlington Danes Academy', N'Ark Burlington Danes Academy'),
(455, 10021051, N'John Cabot Academy', N'John Cabot Academy'),
(456, 10021094, N'Ark Walworth Academy', N'Ark Walworth Academy'),
(457, 10024211, N'Ark Academy', N'Ark Academy'),
(458, 10027834, N'Strood Academy', N'Strood Academy'),
(459, 10027856, N'Ark St Alban''s Academy', N'Ark St Alban''s Academy'),
(460, 10030872, N'JCoSS', N'JCoSS'),
(461, 10030997, N'The John Wallis Church of England Academy', N'The John Wallis Church of England Academy'),
(462, 10031347, N'The Charter School North Dulwich', N'The Charter School North Dulwich'),
(463, 10032199, N'Kingsdale Foundation School', N'Kingsdale Foundation School'),
(464, 10032224, N'Redhill Academy', N'The Redhill Academy'),
(465, 10033293, N'Newquay Tretherras', N'Newquay Tretherras'),
(466, 10033332, N'Windsor High School and Sixth Form', N'Windsor High School and Sixth Form'),
(467, 10033375, N'East Barnet School', N'East Barnet School'),
(468, 10033701, N'The King Edmund School', N'The King Edmund Business & Enterprise School'),
(469, 10034151, N'Aston Manor Academy', N'Aston Manor Academy'),
(470, 10034609, N'Harrow High School', N'Harrow High School'),
(471, 10034667, N'Falmouth School', N'Falmouth School'),
(472, 10035123, N'Biddulph High School', N'Biddulph High School'),
(473, 10035962, N'Denefield School', N'Denefield School'),
(474, 10035996, N'Mulberry Academy Shoreditch', N'Mulberry Academy Shoreditch'),
(475, 10036754, N'Saint Michael''s Catholic High School', N'Saint Michael''s Catholic High School'),
(476, 10037197, N'Loreto College', N'Loreto College'),
(477, 10037660, N'Outwood Academy Valley', N'Outwood Academy Valley'),
(478, 10037675, N'St Mary''s Church of England High School (VA)', N'St Mary''s Church of England High School (VA)'),
(479, 10038069, N'Sacred Heart Catholic School', N'Sacred Heart Catholic School'),
(480, 10038460, N'Ark Isaac Newton Academy', N'Ark Isaac Newton Academy'),
(481, 10038719, N'Ark Bolingbroke Academy', N'Ark Bolingbroke Academy'),
(482, 10038740, N'Tauheedul Islam Boys'' High School', N'Tauheedul Islam Boys'' High School'),
(483, 10041525, N'Harris Academy Chobham', N'Harris Academy Chobham'),
(484, 10041666, N'UTC Reading', N'UTC Reading'),
(485, 10042190, N'Jancett Childcare & Jace Training Limited  ', N'JACE Training and Assessment Centre'),
(486, 10042235, N'Washwood Heath Academy', N'Washwood Heath Academy'),
(487, 10042318, N'Ark John Keats Academy', N'Ark John Keats Academy'),
(488, 10046437, N'Ark Elvin Academy', N'Ark Elvin Academy'),
(489, 10047506, N'Outwood Academy Newbold', N'Outwood Academy Newbold'),
(490, 10048070, N'Tauheedul Islam Girls'' High School', N'Tauheedul Islam Girls'' High School'),
(491, 10048946, N'Our Lady and St Chad Catholic Academy  ', N'Our Lady and St Chad Catholic Academy'),
(492, 10049662, N'Haileybury Turnford', N'Haileybury Turnford'),
(493, 10053251, N'Shireland Biomedical UTC', N'Shireland Biomedical UTC'),
(494, 10053874, N'One Sixth Form College', N'One Sixth Form College'),
(495, 10053984, N'University Collegiate School', N'University Collegiate School'),
(496, 10053987, N'UTC Oxfordshire', N'UTC Oxfordshire'),
(497, 10053995, N'IKB Academy', N'IKB Academy'),
(498, 10056990, N'The Charter School East Dulwich', N'The Charter School East Dulwich'),
(499, 10057005, N'Logic Studio School', N'Logic Studio School'),
(500, 10057026, N'Scarborough University Technical College', N'Scarborough University Technical College'),
(501, 10057307, N'Woodpecker Court Youth Activities Limited', N'Woodpecker Court Youth Activities Limited'),
(502, 10061562, N'Mulberry School for Girls', N'Mulberry School for Girls'),
(503, 10062354, N'Lees Brook Academy', N'Lees Brook Academy'),
(504, 10062380, N'Outwood Academy Danum', N'Outwood Academy Danum'),
(505, 10063457, N'St Benedict''s Catholic High School', N'St Benedict''s Catholic High School'),
(506, 10064870, N'Queen Katharine Academy', N'Queen Katharine Academy'),
(507, 10065005, N'New College Doncaster', N'New College Doncaster'),
(508, 10066064, N'Great Wyrley Academy', N'Great Wyrley High School'),
(509, 10066337, N'Folkestone Academy', N'Folkestone Academy'),
(510, 10067323, N'Outwood Academy Hemsworth', N'Outwood Academy Hemsworth'),
(511, 10080890, N'Action High School', N'Action High School'),
(512, 10081054, N'AldridgeUTC@MediaCityUK', N'AldridgeUTC@MediaCityUK'),
(513, 10081063, N'UTC Heathrow', N'UTC Heathrow'),
(514, 10082095, N'Waterfront UTC', N'Waterfront UTC'),
(515, 10091878, N'Ernest Bevin Academy', N'Ernest Bevin Academy'),
(516, 10092770, N'Leigh Academy Bexley', N'Leigh Academy Bexley'),
(517, 10093936, N'South Bank University Sixth Form', N'South Bank University Sixth Form'),
(518, 10094574, N'Writtle College Limited', N'Writtle College Limited')
)
