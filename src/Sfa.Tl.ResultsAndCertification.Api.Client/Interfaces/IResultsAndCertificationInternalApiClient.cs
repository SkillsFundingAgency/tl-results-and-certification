...
namespace Sfa.Tl.ResultsAndCertification.Api.Client.Interfaces
{
    public interface IResultsAndCertificationInternalApiClient
    {
        ...
        Task<bool> ProcessChangeAcademicYearAsync(ChangeAcademicYearRequest model, int profileId);
        ...
        Task<IList<DataExportResponse>> GenerateRommDataExportAsync(long aoUkprn, string requestedBy);
