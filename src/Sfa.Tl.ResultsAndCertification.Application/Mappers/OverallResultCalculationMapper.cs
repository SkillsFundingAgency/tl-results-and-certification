    ...
    public class OverallResultCalculationMapper : Profile
    {
        public OverallResultCalculationMapper()
        {
            CreateMap<OverallResult, DownloadOverallResultsData>()
                ...
                .ForMember(d => d.SpecialismComponent, opts => opts.ConvertUsing(new SpecialismNameConverter(), s => s.TqRegistrationPathway.TqRegistrationSpecialisms))
                .ForMember(d => d.SpecialismCode, opts => opts.ConvertUsing(new SpecialismCodeConverter(), s => s.TqRegistrationPathway.TqRegistrationSpecialisms))
