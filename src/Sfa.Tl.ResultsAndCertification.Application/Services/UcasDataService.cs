...
namespace Sfa.Tl.ResultsAndCertification.Application.Services
{
    public class UcasDataService : IUcasDataService
    {
        ...
        private async Task<UcasData> ProcessUcasDataRecordEntriesAsync()
        {
            ...
            IList<TqRegistrationPathway> registrationPathways = await _ucasRepository.GetUcasDataRecordsForEntriesAsync();

            foreach (TqRegistrationPathway pathway in registrationPathways)
            {
