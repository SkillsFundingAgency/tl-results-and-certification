...
namespace Sfa.Tl.ResultsAndCertification.Functions
{
    public class CertificatePrintingRequest
    {
        ...
        [FunctionName("SubmitCertificatePrintRequest")]
        public async Task SubmitCertificatePrintRequestAsync([TimerTrigger("%SubmitCertificatePrintRequestTrigger%")] TimerInfo timer, ExecutionContext context, ILogger logger)
        {
            ...
            try
            {
                ...
                var response = await _certificatePrintingService.ProcessPrintRequestAsync();
